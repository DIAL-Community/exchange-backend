...
module Mutations
  class UpdateSiteSettingSectionSettings < Mutations::BaseMutation
    argument :section_configurations, GraphQL::Types::JSON, required: true, default_value: []

    field :site_setting, Types::SiteSettingType, null: true
    field :errors, [String], null: true

    def resolve(section_configurations:)
      ...
      site_setting.section_configurations = section_configurations
