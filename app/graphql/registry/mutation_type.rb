...
module Registry
  class MutationType < Types::BaseObject
    ...
    field :update_site_setting_item_layouts, mutation: Mutations::UpdateSiteSettingItemLayouts
    field :update_site_setting_item_configurations, mutation: Mutations::UpdateSiteSettingItemConfigurations
