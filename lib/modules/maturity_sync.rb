...
module Modules
  module MaturitySync
    def create_category(cat_name, cat_desc = nil)
      ...
      rubric_category_desc.description = cat_desc ? cat_desc : "<p>#{cat_name}</p>"
    ...
    def calculate_product_indicators(product_id, config_file)
