...
namespace :govstack do
  ...
  task sync_govstack_procurements: :environment do
    ...
    if govstack_origin.nil?
      ...
      govstack_origin.description = <<-eos
    ...
    opportunity_nodelist.each do |opportunity_node|
      ...
      opportunity_name = opportunity_node_header.text.gsub('Active: ', '')
      opportunity_slug = slug_em(opportunity_name)
      ...
      opportunity.description = 'GovStack RFP.'
