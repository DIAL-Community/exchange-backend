...
--
-- Name: index_cities_on_region_id; Type: INDEX; Schema: fao; Owner: -
--

CREATE INDEX index_cities_on_region_id ON fao.cities USING btree (region_id);
...
--
-- Name: index_districts_on_region_id; Type: INDEX; Schema: fao; Owner: -
--

CREATE INDEX index_districts_on_region_id ON fao.districts USING btree (region_id);
...
--
-- Name: index_offices_on_region_id; Type: INDEX; Schema: fao; Owner: -
--

CREATE INDEX index_offices_on_region_id ON fao.offices USING btree (region_id);
...
--
-- Name: index_regions_on_country_id; Type: INDEX; Schema: fao; Owner: -
--

CREATE INDEX index_regions_on_country_id ON fao.regions USING btree (country_id);
...
ALTER TABLE ONLY fao.districts
    ADD CONSTRAINT fk_rails_002fc30497 FOREIGN KEY (region_id) REFERENCES fao.regions(id);
...
ALTER TABLE ONLY fao.offices
    ADD CONSTRAINT fk_rails_0722c0e4f7 FOREIGN KEY (region_id) REFERENCES fao.regions(id);
...
ALTER TABLE ONLY fao.cities
    ADD CONSTRAINT fk_rails_e0ef2914ca FOREIGN KEY (region_id) REFERENCES fao.regions(id);
...
--
-- Name: regions fk_rails_f2ba72ccee; Type: FK CONSTRAINT; Schema: fao; Owner: -
--
