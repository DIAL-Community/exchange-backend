...
--
-- Name: organization_type; Type: TYPE; Schema: health; Owner: -
--

CREATE TYPE health.organization_type AS ENUM (
    'owner',
    'maintainer',
    'funder',
    'implementer'
...
--
-- Name: candidate_product_category_indicators; Type: TABLE; Schema: health; Owner: -
--

CREATE TABLE health.candidate_product_category_indicators (
    id bigint NOT NULL,
    candidate_product_id bigint NOT NULL,
    category_indicator_id bigint NOT NULL,
    indicator_value character varying NOT NULL,
...
--
-- Name: candidate_product_category_indicators_id_seq; Type: SEQUENCE; Schema: health; Owner: -
--

CREATE SEQUENCE health.candidate_product_category_indicators_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_product_category_indicators_id_seq; Type: SEQUENCE OWNED BY; Schema: health; Owner: -
--

ALTER SEQUENCE health.candidate_product_category_indicators_id_seq OWNED BY health.candidate_product_category_indicators.id;
...
CREATE TABLE health.organization_datasets (
    ...
    organization_id bigint NOT NULL,
    dataset_id bigint NOT NULL,
    organization_type health.organization_type DEFAULT 'owner'::health.organization_type NOT NULL,
    slug character varying NOT NULL
);
...
CREATE TABLE health.organization_products (
    ...
    id bigint NOT NULL,
    slug character varying NOT NULL,
    organization_type health.organization_type DEFAULT 'owner'::health.organization_type
);
...
CREATE TABLE health.products (
    ...
    tags character varying[] DEFAULT '{}'::character varying[],
    maturity_score jsonb,
    product_type health.product_type DEFAULT 'product'::health.product_type,
    manual_update boolean DEFAULT false,
    commercial_product boolean DEFAULT false,
    pricing_model character varying,
    pricing_details character varying,
...
--
-- Name: extra_attribute_definitions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.extra_attribute_definitions (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
    ...
    description character varying NOT NULL,
    description_fallback character varying,
...
--
-- Name: extra_attribute_definitions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.extra_attribute_definitions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: extra_attribute_definitions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.extra_attribute_definitions_id_seq OWNED BY public.extra_attribute_definitions.id;
...
--
-- Name: candidate_product_category_indicators id; Type: DEFAULT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_product_category_indicators ALTER COLUMN id SET DEFAULT nextval('health.candidate_product_category_indicators_id_seq'::regclass);
...
--
-- Name: extra_attribute_definitions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extra_attribute_definitions ALTER COLUMN id SET DEFAULT nextval('public.extra_attribute_definitions_id_seq'::regclass);
...
--
-- Name: candidate_product_category_indicators candidate_product_category_indicators_pkey; Type: CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_product_category_indicators
    ADD CONSTRAINT candidate_product_category_indicators_pkey PRIMARY KEY (id);
...
--
-- Name: extra_attribute_definitions extra_attribute_definitions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extra_attribute_definitions
    ADD CONSTRAINT extra_attribute_definitions_pkey PRIMARY KEY (id);
...
--
-- Name: candidate_product_category_indicator_main_index; Type: INDEX; Schema: health; Owner: -
--

CREATE UNIQUE INDEX candidate_product_category_indicator_main_index ON health.candidate_product_category_indicators USING btree (candidate_product_id, category_indicator_id);


--
-- Name: candidate_product_category_indicator_reverse_index; Type: INDEX; Schema: health; Owner: -
--

CREATE UNIQUE INDEX candidate_product_category_indicator_reverse_index ON health.candidate_product_category_indicators USING btree (category_indicator_id, candidate_product_id);
...
--
-- Name: index_products_on_approval_status_id; Type: INDEX; Schema: health; Owner: -
--

CREATE INDEX index_products_on_approval_status_id ON health.products USING btree (approval_status_id);
...
--
-- Name: index_extra_attribute_definitions_on_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_extra_attribute_definitions_on_name ON public.extra_attribute_definitions USING btree (name);
...
--
-- Name: candidate_product_category_indicators candidate_products_category_indicators_candidate_product_fk; Type: FK CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_product_category_indicators
    ADD CONSTRAINT candidate_products_category_indicators_candidate_product_fk FOREIGN KEY (candidate_product_id) REFERENCES health.candidate_products(id);


--
-- Name: candidate_product_category_indicators candidate_products_category_indicators_category_indicator_fk; Type: FK CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_product_category_indicators
    ADD CONSTRAINT candidate_products_category_indicators_category_indicator_fk FOREIGN KEY (category_indicator_id) REFERENCES health.category_indicators(id);
...
--
-- Name: products fk_rails_178d05e423; Type: FK CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.products
    ADD CONSTRAINT fk_rails_178d05e423 FOREIGN KEY (approval_status_id) REFERENCES health.candidate_statuses(id) ON DELETE SET NULL;
