...
--
-- Name: exchange-tenant; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA "exchange-tenant";
...
--
-- Name: agg_capabilities; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".agg_capabilities AS ENUM (
...
--
-- Name: category_indicator_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".category_indicator_type AS ENUM (
    'boolean',
    'scale',
    'numeric'
);
...
--
-- Name: category_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".category_type AS ENUM (
    'DPI',
    'FUNCTIONAL'
);
...
--
-- Name: comment_object_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".comment_object_type AS ENUM (
    'PRODUCT',
    'OPEN_DATA',
    'PROJECT',
    'USE_CASE',
...
--
-- Name: digisquare_maturity_level; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".digisquare_maturity_level AS ENUM (
    'low',
    'medium',
    'high'
);
...
--
-- Name: endorser_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".endorser_type AS ENUM (
    'none',
    'bronze',
    'silver',
    'gold'
...
--
-- Name: entity_status_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".entity_status_type AS ENUM (
    'BETA',
    'MATURE',
    'SELF-REPORTED',
    'VALIDATED',
...
--
-- Name: filter_nav; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".filter_nav AS ENUM (
    'sdgs',
    'use_cases',
    'workflows',
    'building_blocks',
...
--
-- Name: location_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".location_type AS ENUM (
    'country',
    'point'
);
...
--
-- Name: mapping_status_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".mapping_status_type AS ENUM (
    'BETA',
    'MATURE',
    'SELF-REPORTED',
    'VALIDATED'
...
--
-- Name: mobile_services; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".mobile_services AS ENUM (
    'Airtime',
    'API',
    'HS',
    'Mobile-Internet',
...
--
-- Name: opportunity_status_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".opportunity_status_type AS ENUM (
    'UPCOMING',
    'OPEN',
    'CLOSED'
);
...
--
-- Name: opportunity_type_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".opportunity_type_type AS ENUM (
    'BID',
    'TENDER',
    'INNOVATION',
    'BUILDING BLOCK',
...
--
-- Name: org_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".org_type AS ENUM (
    'owner',
    'maintainer',
    'funder',
    'implementer'
...
--
-- Name: org_type_orig; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".org_type_orig AS ENUM (
    'owner',
    'maintainer'
);
...
--
-- Name: org_type_save; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".org_type_save AS ENUM (
    'owner',
    'maintainer',
    'funder'
);
...
--
-- Name: product_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".product_type AS ENUM (
    'product',
    'dataset',
    'content'
);
...
--
-- Name: product_type_save; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".product_type_save AS ENUM (
    'product',
    'dataset'
);
...
--
-- Name: relationship_type; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".relationship_type AS ENUM (
    'composed',
    'interoperates'
);
...
--
-- Name: top_nav; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".top_nav AS ENUM (
    'sdgs',
    'use_cases',
    'workflows',
    'building_blocks',
...
--
-- Name: user_role; Type: TYPE; Schema: exchange-tenant; Owner: -
--

CREATE TYPE "exchange-tenant".user_role AS ENUM (
    'admin',
    'ict4sdg',
    'principle',
    'user',
...
--
-- Name: aggregator_capabilities; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".aggregator_capabilities (
    id bigint NOT NULL,
    aggregator_id bigint,
    operator_services_id bigint,
    service "exchange-tenant".mobile_services,
    capability "exchange-tenant".agg_capabilities,
...
--
-- Name: aggregator_capabilities_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".aggregator_capabilities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: aggregator_capabilities_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".aggregator_capabilities_id_seq OWNED BY "exchange-tenant".aggregator_capabilities.id;


--
-- Name: ar_internal_metadata; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".ar_internal_metadata (
...
--
-- Name: audits; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".audits (
    id bigint NOT NULL,
...
--
-- Name: audits_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".audits_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: audits_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".audits_id_seq OWNED BY "exchange-tenant".audits.id;


--
-- Name: authors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".authors (
    id bigint NOT NULL,
...
--
-- Name: authors_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".authors_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: authors_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".authors_id_seq OWNED BY "exchange-tenant".authors.id;


--
-- Name: building_block_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".building_block_descriptions (
    id bigint NOT NULL,
...
--
-- Name: building_block_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".building_block_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: building_block_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".building_block_descriptions_id_seq OWNED BY "exchange-tenant".building_block_descriptions.id;


--
-- Name: building_blocks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".building_blocks (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
    ...
    maturity "exchange-tenant".entity_status_type DEFAULT 'DRAFT'::"exchange-tenant".entity_status_type NOT NULL,
    spec_url character varying,
    category "exchange-tenant".category_type,
...
--
-- Name: building_blocks_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".building_blocks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: building_blocks_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".building_blocks_id_seq OWNED BY "exchange-tenant".building_blocks.id;


--
-- Name: candidate_datasets; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_datasets (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: candidate_datasets_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".candidate_datasets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_datasets_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".candidate_datasets_id_seq OWNED BY "exchange-tenant".candidate_datasets.id;


--
-- Name: candidate_organizations; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_organizations (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    website text,
...
--
-- Name: candidate_organizations_contacts; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_organizations_contacts (
...
--
-- Name: candidate_organizations_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".candidate_organizations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_organizations_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".candidate_organizations_id_seq OWNED BY "exchange-tenant".candidate_organizations.id;


--
-- Name: candidate_products; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_products (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
    website character varying NOT NULL,
...
--
-- Name: candidate_products_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".candidate_products_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_products_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".candidate_products_id_seq OWNED BY "exchange-tenant".candidate_products.id;


--
-- Name: candidate_resources; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_resources (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: candidate_resources_countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_resources_countries (
    id bigint NOT NULL,
...
--
-- Name: candidate_resources_countries_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".candidate_resources_countries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_resources_countries_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".candidate_resources_countries_id_seq OWNED BY "exchange-tenant".candidate_resources_countries.id;


--
-- Name: candidate_resources_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".candidate_resources_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_resources_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".candidate_resources_id_seq OWNED BY "exchange-tenant".candidate_resources.id;


--
-- Name: candidate_roles; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_roles (
    id bigint NOT NULL,
    email character varying NOT NULL,
    roles "exchange-tenant".user_role[] DEFAULT '{}'::"exchange-tenant".user_role[],
    description character varying NOT NULL,
    rejected boolean,
    rejected_date timestamp without time zone,
    rejected_by_id bigint,
...
--
-- Name: candidate_roles_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".candidate_roles_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_roles_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".candidate_roles_id_seq OWNED BY "exchange-tenant".candidate_roles.id;


--
-- Name: candidate_status_relationships; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_status_relationships (
    id bigint NOT NULL,
...
--
-- Name: candidate_status_relationships_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".candidate_status_relationships_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_status_relationships_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".candidate_status_relationships_id_seq OWNED BY "exchange-tenant".candidate_status_relationships.id;


--
-- Name: candidate_statuses; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".candidate_statuses (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: candidate_statuses_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".candidate_statuses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_statuses_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".candidate_statuses_id_seq OWNED BY "exchange-tenant".candidate_statuses.id;


--
-- Name: category_indicator_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".category_indicator_descriptions (
    id bigint NOT NULL,
...
--
-- Name: category_indicator_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".category_indicator_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: category_indicator_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".category_indicator_descriptions_id_seq OWNED BY "exchange-tenant".category_indicator_descriptions.id;


--
-- Name: category_indicators; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".category_indicators (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    indicator_type "exchange-tenant".category_indicator_type,
...
--
-- Name: category_indicators_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".category_indicators_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: category_indicators_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".category_indicators_id_seq OWNED BY "exchange-tenant".category_indicators.id;


--
-- Name: chatbot_conversations; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".chatbot_conversations (
    id bigint NOT NULL,
...
--
-- Name: chatbot_conversations_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".chatbot_conversations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: chatbot_conversations_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".chatbot_conversations_id_seq OWNED BY "exchange-tenant".chatbot_conversations.id;


--
-- Name: cities; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".cities (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    province_id bigint,
...
--
-- Name: cities_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".cities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: cities_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".cities_id_seq OWNED BY "exchange-tenant".cities.id;


--
-- Name: ckeditor_assets; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".ckeditor_assets (
    id bigint NOT NULL,
...
--
-- Name: ckeditor_assets_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".ckeditor_assets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ckeditor_assets_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".ckeditor_assets_id_seq OWNED BY "exchange-tenant".ckeditor_assets.id;


--
-- Name: classifications; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".classifications (
    id bigint NOT NULL,
...
--
-- Name: classifications_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".classifications_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: classifications_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".classifications_id_seq OWNED BY "exchange-tenant".classifications.id;


--
-- Name: comments; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".comments (
    id bigint NOT NULL,
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    comment_object_type "exchange-tenant".comment_object_type NOT NULL
);


--
-- Name: comments_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".comments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: comments_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".comments_id_seq OWNED BY "exchange-tenant".comments.id;


--
-- Name: contacts; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".contacts (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    email character varying,
...
--
-- Name: contacts_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".contacts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".contacts_id_seq OWNED BY "exchange-tenant".contacts.id;


--
-- Name: countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".countries (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: countries_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".countries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: countries_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".countries_id_seq OWNED BY "exchange-tenant".countries.id;


--
-- Name: dataset_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".dataset_descriptions (
    id bigint NOT NULL,
    dataset_id bigint,
    locale character varying NOT NULL,
    description character varying DEFAULT ''::character varying NOT NULL,
...
--
-- Name: dataset_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".dataset_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dataset_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".dataset_descriptions_id_seq OWNED BY "exchange-tenant".dataset_descriptions.id;


--
-- Name: dataset_sectors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".dataset_sectors (
    id bigint NOT NULL,
    dataset_id bigint NOT NULL,
    sector_id bigint NOT NULL,
    mapping_status "exchange-tenant".mapping_status_type DEFAULT 'BETA'::"exchange-tenant".mapping_status_type NOT NULL,
    slug character varying NOT NULL
);


--
-- Name: dataset_sectors_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".dataset_sectors_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dataset_sectors_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".dataset_sectors_id_seq OWNED BY "exchange-tenant".dataset_sectors.id;


--
-- Name: dataset_sustainable_development_goals; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".dataset_sustainable_development_goals (
    id bigint NOT NULL,
    dataset_id bigint NOT NULL,
...
--
-- Name: dataset_sustainable_development_goals_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".dataset_sustainable_development_goals_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dataset_sustainable_development_goals_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".dataset_sustainable_development_goals_id_seq OWNED BY "exchange-tenant".dataset_sustainable_development_goals.id;


--
-- Name: datasets; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".datasets (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    aliases character varying[] DEFAULT '{}'::character varying[],
...
--
-- Name: datasets_countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".datasets_countries (
    id bigint NOT NULL,
    dataset_id bigint NOT NULL,
    country_id bigint NOT NULL
);
...
--
-- Name: datasets_countries_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".datasets_countries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: datasets_countries_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".datasets_countries_id_seq OWNED BY "exchange-tenant".datasets_countries.id;


--
-- Name: datasets_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".datasets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: datasets_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".datasets_id_seq OWNED BY "exchange-tenant".datasets.id;


--
-- Name: datasets_origins; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".datasets_origins (
    id bigint NOT NULL,
    dataset_id bigint NOT NULL,
...
--
-- Name: datasets_origins_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".datasets_origins_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: datasets_origins_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".datasets_origins_id_seq OWNED BY "exchange-tenant".datasets_origins.id;


--
-- Name: deploys; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".deploys (
    id bigint NOT NULL,
    user_id bigint,
    product_id bigint,
...
--
-- Name: deploys_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".deploys_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: deploys_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".deploys_id_seq OWNED BY "exchange-tenant".deploys.id;


--
-- Name: dial_spreadsheet_data; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".dial_spreadsheet_data (
    id bigint NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: dial_spreadsheet_data_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".dial_spreadsheet_data_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dial_spreadsheet_data_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".dial_spreadsheet_data_id_seq OWNED BY "exchange-tenant".dial_spreadsheet_data.id;


--
-- Name: digital_principles; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".digital_principles (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: digital_principles_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".digital_principles_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: digital_principles_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".digital_principles_id_seq OWNED BY "exchange-tenant".digital_principles.id;


--
-- Name: districts; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".districts (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: districts_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".districts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: districts_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".districts_id_seq OWNED BY "exchange-tenant".districts.id;


--
-- Name: endorsers; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".endorsers (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
    description character varying
...
--
-- Name: endorsers_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".endorsers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: endorsers_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".endorsers_id_seq OWNED BY "exchange-tenant".endorsers.id;


--
-- Name: exchange_tenants; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".exchange_tenants (
    id bigint NOT NULL,
...
--
-- Name: exchange_tenants_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".exchange_tenants_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: exchange_tenants_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".exchange_tenants_id_seq OWNED BY "exchange-tenant".exchange_tenants.id;


--
-- Name: froala_images; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".froala_images (
    id bigint NOT NULL,
...
--
-- Name: froala_images_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".froala_images_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: froala_images_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".froala_images_id_seq OWNED BY "exchange-tenant".froala_images.id;


--
-- Name: glossaries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".glossaries (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    locale character varying NOT NULL,
...
--
-- Name: glossaries_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".glossaries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: glossaries_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".glossaries_id_seq OWNED BY "exchange-tenant".glossaries.id;


--
-- Name: handbook_answers; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".handbook_answers (
    id bigint NOT NULL,
...
--
-- Name: handbook_answers_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".handbook_answers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: handbook_answers_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".handbook_answers_id_seq OWNED BY "exchange-tenant".handbook_answers.id;


--
-- Name: handbook_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".handbook_descriptions (
    id bigint NOT NULL,
    handbook_id bigint,
    locale character varying NOT NULL,
...
--
-- Name: handbook_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".handbook_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: handbook_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".handbook_descriptions_id_seq OWNED BY "exchange-tenant".handbook_descriptions.id;


--
-- Name: handbook_pages; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".handbook_pages (
    id bigint NOT NULL,
...
--
-- Name: handbook_pages_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".handbook_pages_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: handbook_pages_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".handbook_pages_id_seq OWNED BY "exchange-tenant".handbook_pages.id;


--
-- Name: handbook_questions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".handbook_questions (
    id bigint NOT NULL,
...
--
-- Name: handbook_questions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".handbook_questions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: handbook_questions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".handbook_questions_id_seq OWNED BY "exchange-tenant".handbook_questions.id;


--
-- Name: handbooks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".handbooks (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: handbooks_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".handbooks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: handbooks_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".handbooks_id_seq OWNED BY "exchange-tenant".handbooks.id;


--
-- Name: messages; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".messages (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: messages_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".messages_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: messages_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".messages_id_seq OWNED BY "exchange-tenant".messages.id;


--
-- Name: offices; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".offices (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    latitude numeric NOT NULL,
...
--
-- Name: offices_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".offices_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: offices_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".offices_id_seq OWNED BY "exchange-tenant".offices.id;


--
-- Name: operator_services; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".operator_services (
    id bigint NOT NULL,
    name character varying,
    service "exchange-tenant".mobile_services,
    country_id bigint,
...
--
-- Name: operator_services_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".operator_services_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: operator_services_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".operator_services_id_seq OWNED BY "exchange-tenant".operator_services.id;


--
-- Name: opportunities; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".opportunities (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    description character varying NOT NULL,
    ...
    opportunity_type "exchange-tenant".opportunity_type_type DEFAULT 'OTHER'::"exchange-tenant".opportunity_type_type NOT NULL,
    opportunity_status "exchange-tenant".opportunity_status_type DEFAULT 'UPCOMING'::"exchange-tenant".opportunity_status_type NOT NULL,
...
--
-- Name: opportunities_building_blocks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".opportunities_building_blocks (
...
--
-- Name: opportunities_countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".opportunities_countries (
    country_id bigint,
    opportunity_id bigint
);
...
--
-- Name: opportunities_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".opportunities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: opportunities_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".opportunities_id_seq OWNED BY "exchange-tenant".opportunities.id;


--
-- Name: opportunities_organizations; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".opportunities_organizations (
...
--
-- Name: opportunities_sectors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".opportunities_sectors (
    sector_id bigint,
    opportunity_id bigint
);
...
--
-- Name: opportunities_use_cases; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".opportunities_use_cases (
    use_case_id bigint,
    opportunity_id bigint
);
...
--
-- Name: organization_contacts; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".organization_contacts (
    organization_id bigint NOT NULL,
    contact_id bigint NOT NULL,
    started_at timestamp without time zone,
    ended_at timestamp without time zone,
...
--
-- Name: organization_contacts_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".organization_contacts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".organization_contacts_id_seq OWNED BY "exchange-tenant".organization_contacts.id;


--
-- Name: organization_datasets; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".organization_datasets (
    id bigint NOT NULL,
    organization_id bigint NOT NULL,
    dataset_id bigint NOT NULL,
    organization_type "exchange-tenant".org_type DEFAULT 'owner'::"exchange-tenant".org_type NOT NULL,
    slug character varying NOT NULL
);


--
-- Name: organization_datasets_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".organization_datasets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_datasets_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".organization_datasets_id_seq OWNED BY "exchange-tenant".organization_datasets.id;


--
-- Name: organization_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".organization_descriptions (
    id bigint NOT NULL,
    organization_id bigint NOT NULL,
    locale character varying NOT NULL,
    description character varying DEFAULT ''::character varying NOT NULL,
...
--
-- Name: organization_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".organization_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".organization_descriptions_id_seq OWNED BY "exchange-tenant".organization_descriptions.id;


--
-- Name: organization_products; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".organization_products (
    organization_id bigint NOT NULL,
    product_id bigint NOT NULL,
    id bigint NOT NULL,
    slug character varying NOT NULL,
    org_type "exchange-tenant".org_type DEFAULT 'owner'::"exchange-tenant".org_type
);


--
-- Name: organization_products_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".organization_products_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_products_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".organization_products_id_seq OWNED BY "exchange-tenant".organization_products.id;


--
-- Name: organizations; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".organizations (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    ...
    aliases character varying[] DEFAULT '{}'::character varying[],
    endorser_level "exchange-tenant".endorser_type DEFAULT 'none'::"exchange-tenant".endorser_type,
...
--
-- Name: organizations_countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".organizations_countries (
    id bigint NOT NULL,
    organization_id bigint NOT NULL,
    country_id bigint NOT NULL
);
...
--
-- Name: organizations_countries_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".organizations_countries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organizations_countries_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".organizations_countries_id_seq OWNED BY "exchange-tenant".organizations_countries.id;


--
-- Name: organizations_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".organizations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organizations_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".organizations_id_seq OWNED BY "exchange-tenant".organizations.id;


--
-- Name: organizations_resources; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".organizations_resources (
    id bigint NOT NULL,
    organization_id bigint NOT NULL,
...
--
-- Name: organizations_resources_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".organizations_resources_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organizations_resources_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".organizations_resources_id_seq OWNED BY "exchange-tenant".organizations_resources.id;


--
-- Name: organizations_sectors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".organizations_sectors (
    sector_id bigint NOT NULL,
    organization_id bigint NOT NULL
);
...
--
-- Name: origins; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".origins (
    id bigint NOT NULL,
    organization_id bigint,
    name character varying,
...
--
-- Name: origins_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".origins_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: origins_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".origins_id_seq OWNED BY "exchange-tenant".origins.id;


--
-- Name: page_contents; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".page_contents (
    id bigint NOT NULL,
    handbook_page_id bigint,
    locale character varying NOT NULL,
...
--
-- Name: page_contents_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".page_contents_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: page_contents_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".page_contents_id_seq OWNED BY "exchange-tenant".page_contents.id;


--
-- Name: play_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".play_descriptions (
    id bigint NOT NULL,
    play_id bigint,
    locale character varying NOT NULL,
    description character varying NOT NULL
...
--
-- Name: play_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".play_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: play_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".play_descriptions_id_seq OWNED BY "exchange-tenant".play_descriptions.id;


--
-- Name: play_move_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".play_move_descriptions (
    id bigint NOT NULL,
    play_move_id bigint,
    locale character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: play_move_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".play_move_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: play_move_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".play_move_descriptions_id_seq OWNED BY "exchange-tenant".play_move_descriptions.id;


--
-- Name: play_moves; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".play_moves (
    id bigint NOT NULL,
    play_id bigint,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: play_moves_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".play_moves_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: play_moves_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".play_moves_id_seq OWNED BY "exchange-tenant".play_moves.id;


--
-- Name: play_moves_resources; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".play_moves_resources (
    id bigint NOT NULL,
...
--
-- Name: play_moves_resources_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".play_moves_resources_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: play_moves_resources_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".play_moves_resources_id_seq OWNED BY "exchange-tenant".play_moves_resources.id;


--
-- Name: playbook_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".playbook_descriptions (
    id bigint NOT NULL,
    playbook_id bigint,
    locale character varying NOT NULL,
...
--
-- Name: playbook_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".playbook_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: playbook_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".playbook_descriptions_id_seq OWNED BY "exchange-tenant".playbook_descriptions.id;


--
-- Name: playbook_plays; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".playbook_plays (
    id bigint NOT NULL,
...
--
-- Name: playbook_plays_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".playbook_plays_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: playbook_plays_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".playbook_plays_id_seq OWNED BY "exchange-tenant".playbook_plays.id;


--
-- Name: playbooks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".playbooks (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    phases jsonb DEFAULT '[]'::jsonb NOT NULL,
...
--
-- Name: playbooks_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".playbooks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: playbooks_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".playbooks_id_seq OWNED BY "exchange-tenant".playbooks.id;


--
-- Name: playbooks_sectors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".playbooks_sectors (
    playbook_id bigint NOT NULL,
    sector_id bigint NOT NULL
);
...
--
-- Name: plays; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".plays (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    author character varying,
...
--
-- Name: plays_building_blocks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".plays_building_blocks (
    id bigint NOT NULL,
    play_id bigint,
    building_block_id bigint
);
...
--
-- Name: plays_building_blocks_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".plays_building_blocks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: plays_building_blocks_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".plays_building_blocks_id_seq OWNED BY "exchange-tenant".plays_building_blocks.id;


--
-- Name: plays_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".plays_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: plays_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".plays_id_seq OWNED BY "exchange-tenant".plays.id;


--
-- Name: plays_products; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".plays_products (
    id bigint NOT NULL,
    play_id bigint,
    product_id bigint
);
...
--
-- Name: plays_products_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".plays_products_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: plays_products_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".plays_products_id_seq OWNED BY "exchange-tenant".plays_products.id;


--
-- Name: plays_subplays; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".plays_subplays (
    id bigint NOT NULL,
...
--
-- Name: plays_subplays_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".plays_subplays_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: plays_subplays_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".plays_subplays_id_seq OWNED BY "exchange-tenant".plays_subplays.id;


--
-- Name: portal_views; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".portal_views (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: portal_views_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".portal_views_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: portal_views_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".portal_views_id_seq OWNED BY "exchange-tenant".portal_views.id;


--
-- Name: principle_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".principle_descriptions (
    id bigint NOT NULL,
...
--
-- Name: principle_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".principle_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: principle_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".principle_descriptions_id_seq OWNED BY "exchange-tenant".principle_descriptions.id;


--
-- Name: product_building_blocks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_building_blocks (
    building_block_id bigint NOT NULL,
    product_id bigint NOT NULL,
    mapping_status "exchange-tenant".mapping_status_type DEFAULT 'BETA'::"exchange-tenant".mapping_status_type NOT NULL,
    id bigint NOT NULL,
...
--
-- Name: product_building_blocks_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".product_building_blocks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_building_blocks_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".product_building_blocks_id_seq OWNED BY "exchange-tenant".product_building_blocks.id;


--
-- Name: product_categories; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_categories (
    product_id bigint,
...
--
-- Name: product_classifications; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_classifications (
    id bigint NOT NULL,
    product_id bigint,
...
--
-- Name: product_classifications_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".product_classifications_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_classifications_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".product_classifications_id_seq OWNED BY "exchange-tenant".product_classifications.id;


--
-- Name: product_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_descriptions (
    id bigint NOT NULL,
    product_id bigint NOT NULL,
    locale character varying NOT NULL,
    description character varying DEFAULT ''::character varying NOT NULL,
...
--
-- Name: product_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".product_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".product_descriptions_id_seq OWNED BY "exchange-tenant".product_descriptions.id;


--
-- Name: product_features; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_features (
    product_id bigint,
...
--
-- Name: product_indicators; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_indicators (
    id bigint NOT NULL,
    product_id bigint NOT NULL,
    category_indicator_id bigint NOT NULL,
...
--
-- Name: product_indicators_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".product_indicators_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_indicators_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".product_indicators_id_seq OWNED BY "exchange-tenant".product_indicators.id;


--
-- Name: product_product_relationships; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_product_relationships (
    id bigint NOT NULL,
    from_product_id bigint NOT NULL,
    to_product_id bigint NOT NULL,
    relationship_type "exchange-tenant".relationship_type NOT NULL,
    slug character varying NOT NULL
);


--
-- Name: product_product_relationships_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".product_product_relationships_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_product_relationships_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".product_product_relationships_id_seq OWNED BY "exchange-tenant".product_product_relationships.id;


--
-- Name: product_repositories; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_repositories (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    product_id bigint NOT NULL,
...
--
-- Name: product_repositories_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".product_repositories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_repositories_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".product_repositories_id_seq OWNED BY "exchange-tenant".product_repositories.id;


--
-- Name: product_sectors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_sectors (
    product_id bigint NOT NULL,
    sector_id bigint NOT NULL,
    mapping_status "exchange-tenant".mapping_status_type DEFAULT 'BETA'::"exchange-tenant".mapping_status_type NOT NULL,
    id bigint NOT NULL,
...
--
-- Name: product_sectors_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".product_sectors_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_sectors_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".product_sectors_id_seq OWNED BY "exchange-tenant".product_sectors.id;


--
-- Name: product_sustainable_development_goals; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".product_sustainable_development_goals (
    product_id bigint NOT NULL,
    sustainable_development_goal_id bigint NOT NULL,
    mapping_status "exchange-tenant".mapping_status_type DEFAULT 'BETA'::"exchange-tenant".mapping_status_type NOT NULL,
    id bigint NOT NULL,
...
--
-- Name: product_sustainable_development_goals_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".product_sustainable_development_goals_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_sustainable_development_goals_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".product_sustainable_development_goals_id_seq OWNED BY "exchange-tenant".product_sustainable_development_goals.id;


--
-- Name: products; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".products (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    website character varying,
    ...
    product_type "exchange-tenant".product_type_save DEFAULT 'product'::"exchange-tenant".product_type_save,
    manual_update boolean DEFAULT false,
...
--
-- Name: products_countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".products_countries (
    id bigint NOT NULL,
    product_id bigint NOT NULL,
    country_id bigint NOT NULL
);
...
--
-- Name: products_countries_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".products_countries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: products_countries_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".products_countries_id_seq OWNED BY "exchange-tenant".products_countries.id;


--
-- Name: products_endorsers; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".products_endorsers (
    id bigint NOT NULL,
    product_id bigint NOT NULL,
...
--
-- Name: products_endorsers_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".products_endorsers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: products_endorsers_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".products_endorsers_id_seq OWNED BY "exchange-tenant".products_endorsers.id;


--
-- Name: products_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".products_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: products_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".products_id_seq OWNED BY "exchange-tenant".products.id;


--
-- Name: products_origins; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".products_origins (
    product_id bigint NOT NULL,
    origin_id bigint NOT NULL
);
...
--
-- Name: products_resources; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".products_resources (
    product_id bigint NOT NULL,
    resource_id bigint NOT NULL
);
...
--
-- Name: project_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".project_descriptions (
    id bigint NOT NULL,
...
--
-- Name: project_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".project_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: project_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".project_descriptions_id_seq OWNED BY "exchange-tenant".project_descriptions.id;


--
-- Name: projects; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".projects (
    id bigint NOT NULL,
    origin_id bigint,
    start_date date,
    end_date date,
...
--
-- Name: projects_countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".projects_countries (
    id bigint NOT NULL,
    project_id bigint NOT NULL,
    country_id bigint NOT NULL
);
...
--
-- Name: projects_countries_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".projects_countries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: projects_countries_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".projects_countries_id_seq OWNED BY "exchange-tenant".projects_countries.id;


--
-- Name: projects_digital_principles; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".projects_digital_principles (
    id bigint NOT NULL,
    project_id bigint NOT NULL,
...
--
-- Name: projects_digital_principles_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".projects_digital_principles_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: projects_digital_principles_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".projects_digital_principles_id_seq OWNED BY "exchange-tenant".projects_digital_principles.id;


--
-- Name: projects_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".projects_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: projects_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".projects_id_seq OWNED BY "exchange-tenant".projects.id;


--
-- Name: projects_organizations; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".projects_organizations (
    project_id bigint NOT NULL,
    organization_id bigint NOT NULL,
    org_type "exchange-tenant".org_type DEFAULT 'owner'::"exchange-tenant".org_type,
...
--
-- Name: projects_products; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".projects_products (
    project_id bigint NOT NULL,
    product_id bigint NOT NULL
);
...
--
-- Name: projects_sdgs; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".projects_sdgs (
    project_id bigint NOT NULL,
...
--
-- Name: projects_sectors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".projects_sectors (
    project_id bigint NOT NULL,
    sector_id bigint NOT NULL
);
...
--
-- Name: provinces; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".provinces (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    country_id bigint NOT NULL,
...
--
-- Name: provinces_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".provinces_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: provinces_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".provinces_id_seq OWNED BY "exchange-tenant".provinces.id;


--
-- Name: regions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".regions (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: regions_countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".regions_countries (
...
--
-- Name: regions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".regions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: regions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".regions_id_seq OWNED BY "exchange-tenant".regions.id;


--
-- Name: resource_building_blocks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".resource_building_blocks (
    id bigint NOT NULL,
    resource_id bigint NOT NULL,
    building_block_id bigint NOT NULL,
    mapping_status "exchange-tenant".mapping_status_type DEFAULT 'BETA'::"exchange-tenant".mapping_status_type,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
);
...
--
-- Name: resource_building_blocks_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".resource_building_blocks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: resource_building_blocks_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".resource_building_blocks_id_seq OWNED BY "exchange-tenant".resource_building_blocks.id;


--
-- Name: resource_topic_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".resource_topic_descriptions (
    id bigint NOT NULL,
    locale character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: resource_topic_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".resource_topic_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: resource_topic_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".resource_topic_descriptions_id_seq OWNED BY "exchange-tenant".resource_topic_descriptions.id;


--
-- Name: resource_topics; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".resource_topics (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
...
--
-- Name: resource_topics_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".resource_topics_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: resource_topics_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".resource_topics_id_seq OWNED BY "exchange-tenant".resource_topics.id;


--
-- Name: resource_types; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".resource_types (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: resource_types_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".resource_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: resource_types_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".resource_types_id_seq OWNED BY "exchange-tenant".resource_types.id;


--
-- Name: resources; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".resources (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: resources_authors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".resources_authors (
    resource_id bigint NOT NULL,
...
--
-- Name: resources_countries; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".resources_countries (
    resource_id bigint NOT NULL,
    country_id bigint NOT NULL
);
...
--
-- Name: resources_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".resources_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: resources_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".resources_id_seq OWNED BY "exchange-tenant".resources.id;


--
-- Name: resources_use_cases; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".resources_use_cases (
    id bigint NOT NULL,
    resource_id bigint NOT NULL,
...
--
-- Name: resources_use_cases_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".resources_use_cases_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: resources_use_cases_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".resources_use_cases_id_seq OWNED BY "exchange-tenant".resources_use_cases.id;


--
-- Name: rubric_categories; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".rubric_categories (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    weight numeric DEFAULT 0 NOT NULL,
...
--
-- Name: rubric_categories_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".rubric_categories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: rubric_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".rubric_categories_id_seq OWNED BY "exchange-tenant".rubric_categories.id;


--
-- Name: rubric_category_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".rubric_category_descriptions (
    id bigint NOT NULL,
...
--
-- Name: rubric_category_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".rubric_category_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: rubric_category_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".rubric_category_descriptions_id_seq OWNED BY "exchange-tenant".rubric_category_descriptions.id;


--
-- Name: schema_migrations; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".schema_migrations (
    version character varying NOT NULL
);


--
-- Name: sdg_targets; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".sdg_targets (
    id bigint NOT NULL,
    name character varying NOT NULL,
...
--
-- Name: sdg_targets_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".sdg_targets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sdg_targets_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".sdg_targets_id_seq OWNED BY "exchange-tenant".sdg_targets.id;


--
-- Name: sectors; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".sectors (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: sectors_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".sectors_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sectors_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".sectors_id_seq OWNED BY "exchange-tenant".sectors.id;


--
-- Name: sessions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".sessions (
    id bigint NOT NULL,
...
--
-- Name: sessions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".sessions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sessions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".sessions_id_seq OWNED BY "exchange-tenant".sessions.id;


--
-- Name: settings; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".settings (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: settings_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: settings_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".settings_id_seq OWNED BY "exchange-tenant".settings.id;


--
-- Name: site_settings; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".site_settings (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: site_settings_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".site_settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: site_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".site_settings_id_seq OWNED BY "exchange-tenant".site_settings.id;


--
-- Name: software_categories; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".software_categories (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: software_categories_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".software_categories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: software_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".software_categories_id_seq OWNED BY "exchange-tenant".software_categories.id;


--
-- Name: software_features; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".software_features (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: software_features_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".software_features_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: software_features_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".software_features_id_seq OWNED BY "exchange-tenant".software_features.id;


--
-- Name: starred_objects; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".starred_objects (
    id bigint NOT NULL,
...
--
-- Name: starred_objects_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".starred_objects_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: starred_objects_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".starred_objects_id_seq OWNED BY "exchange-tenant".starred_objects.id;


--
-- Name: stylesheets; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".stylesheets (
    id bigint NOT NULL,
...
--
-- Name: stylesheets_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".stylesheets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: stylesheets_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".stylesheets_id_seq OWNED BY "exchange-tenant".stylesheets.id;


--
-- Name: sustainable_development_goals; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".sustainable_development_goals (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
...
--
-- Name: sustainable_development_goals_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".sustainable_development_goals_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sustainable_development_goals_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".sustainable_development_goals_id_seq OWNED BY "exchange-tenant".sustainable_development_goals.id;


--
-- Name: tag_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".tag_descriptions (
    id bigint NOT NULL,
...
--
-- Name: tag_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".tag_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tag_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".tag_descriptions_id_seq OWNED BY "exchange-tenant".tag_descriptions.id;


--
-- Name: tags; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".tags (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: tags_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".tags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tags_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".tags_id_seq OWNED BY "exchange-tenant".tags.id;


--
-- Name: task_tracker_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".task_tracker_descriptions (
    id bigint NOT NULL,
...
--
-- Name: task_tracker_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".task_tracker_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: task_tracker_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".task_tracker_descriptions_id_seq OWNED BY "exchange-tenant".task_tracker_descriptions.id;


--
-- Name: task_trackers; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".task_trackers (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: task_trackers_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".task_trackers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: task_trackers_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".task_trackers_id_seq OWNED BY "exchange-tenant".task_trackers.id;


--
-- Name: tenant_sync_configurations; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".tenant_sync_configurations (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: tenant_sync_configurations_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".tenant_sync_configurations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tenant_sync_configurations_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".tenant_sync_configurations_id_seq OWNED BY "exchange-tenant".tenant_sync_configurations.id;


--
-- Name: use_case_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_case_descriptions (
    id bigint NOT NULL,
    use_case_id bigint NOT NULL,
    locale character varying NOT NULL,
    description character varying DEFAULT ''::character varying NOT NULL
...
--
-- Name: use_case_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".use_case_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: use_case_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".use_case_descriptions_id_seq OWNED BY "exchange-tenant".use_case_descriptions.id;


--
-- Name: use_case_headers; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_case_headers (
    id bigint NOT NULL,
    use_case_id bigint NOT NULL,
    locale character varying NOT NULL,
...
--
-- Name: use_case_headers_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".use_case_headers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: use_case_headers_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".use_case_headers_id_seq OWNED BY "exchange-tenant".use_case_headers.id;


--
-- Name: use_case_step_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_case_step_descriptions (
    id bigint NOT NULL,
...
--
-- Name: use_case_step_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".use_case_step_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: use_case_step_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".use_case_step_descriptions_id_seq OWNED BY "exchange-tenant".use_case_step_descriptions.id;


--
-- Name: use_case_steps; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_case_steps (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
...
--
-- Name: use_case_steps_building_blocks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_case_steps_building_blocks (
    id bigint NOT NULL,
    use_case_step_id bigint NOT NULL,
    building_block_id bigint NOT NULL
);
...
--
-- Name: use_case_steps_building_blocks_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".use_case_steps_building_blocks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: use_case_steps_building_blocks_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".use_case_steps_building_blocks_id_seq OWNED BY "exchange-tenant".use_case_steps_building_blocks.id;


--
-- Name: use_case_steps_datasets; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_case_steps_datasets (
    id bigint NOT NULL,
    use_case_step_id bigint NOT NULL,
    dataset_id bigint NOT NULL
);
...
--
-- Name: use_case_steps_datasets_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".use_case_steps_datasets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: use_case_steps_datasets_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".use_case_steps_datasets_id_seq OWNED BY "exchange-tenant".use_case_steps_datasets.id;


--
-- Name: use_case_steps_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".use_case_steps_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: use_case_steps_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".use_case_steps_id_seq OWNED BY "exchange-tenant".use_case_steps.id;


--
-- Name: use_case_steps_products; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_case_steps_products (
    id bigint NOT NULL,
    use_case_step_id bigint NOT NULL,
    product_id bigint NOT NULL
);
...
--
-- Name: use_case_steps_products_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".use_case_steps_products_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: use_case_steps_products_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".use_case_steps_products_id_seq OWNED BY "exchange-tenant".use_case_steps_products.id;


--
-- Name: use_case_steps_workflows; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_case_steps_workflows (
    use_case_step_id bigint NOT NULL,
...
--
-- Name: use_cases; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_cases (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    sector_id bigint NOT NULL,
...
--
-- Name: use_cases_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".use_cases_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: use_cases_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".use_cases_id_seq OWNED BY "exchange-tenant".use_cases.id;


--
-- Name: use_cases_sdg_targets; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".use_cases_sdg_targets (
    use_case_id bigint NOT NULL,
...
--
-- Name: user_events; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".user_events (
    id bigint NOT NULL,
    identifier character varying NOT NULL,
    email character varying,
...
--
-- Name: user_events_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".user_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_events_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".user_events_id_seq OWNED BY "exchange-tenant".user_events.id;


--
-- Name: user_messages; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".user_messages (
    id bigint NOT NULL,
...
--
-- Name: user_messages_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".user_messages_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_messages_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".user_messages_id_seq OWNED BY "exchange-tenant".user_messages.id;


--
-- Name: users; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".users (
    id bigint NOT NULL,
...
--
-- Name: users_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".users_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".users_id_seq OWNED BY "exchange-tenant".users.id;


--
-- Name: workflow_descriptions; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".workflow_descriptions (
    id bigint NOT NULL,
    workflow_id bigint NOT NULL,
    locale character varying NOT NULL,
    description character varying DEFAULT ''::character varying NOT NULL
...
--
-- Name: workflow_descriptions_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".workflow_descriptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: workflow_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".workflow_descriptions_id_seq OWNED BY "exchange-tenant".workflow_descriptions.id;


--
-- Name: workflows; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".workflows (
    id bigint NOT NULL,
    name character varying NOT NULL,
    slug character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: workflows_building_blocks; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".workflows_building_blocks (
    workflow_id bigint NOT NULL,
    building_block_id bigint NOT NULL
);
...
--
-- Name: workflows_id_seq; Type: SEQUENCE; Schema: exchange-tenant; Owner: -
--

CREATE SEQUENCE "exchange-tenant".workflows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: workflows_id_seq; Type: SEQUENCE OWNED BY; Schema: exchange-tenant; Owner: -
--

ALTER SEQUENCE "exchange-tenant".workflows_id_seq OWNED BY "exchange-tenant".workflows.id;


--
-- Name: workflows_use_cases; Type: TABLE; Schema: exchange-tenant; Owner: -
--

CREATE TABLE "exchange-tenant".workflows_use_cases (
    workflow_id bigint NOT NULL,
    use_case_id bigint NOT NULL
);
...
--
-- Name: candidate_status_relationships; Type: TABLE; Schema: health; Owner: -
--

CREATE TABLE health.candidate_status_relationships (
    id bigint NOT NULL,
    current_candidate_status_id bigint NOT NULL,
    next_candidate_status_id bigint NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
...
--
-- Name: candidate_status_relationships_id_seq; Type: SEQUENCE; Schema: health; Owner: -
--

CREATE SEQUENCE health.candidate_status_relationships_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_status_relationships_id_seq; Type: SEQUENCE OWNED BY; Schema: health; Owner: -
--

ALTER SEQUENCE health.candidate_status_relationships_id_seq OWNED BY health.candidate_status_relationships.id;


--
-- Name: candidate_statuses; Type: TABLE; Schema: health; Owner: -
--

CREATE TABLE health.candidate_statuses (
    id bigint NOT NULL,
    slug character varying NOT NULL,
    name character varying NOT NULL,
    description character varying NOT NULL,
...
--
-- Name: candidate_statuses_id_seq; Type: SEQUENCE; Schema: health; Owner: -
--

CREATE SEQUENCE health.candidate_statuses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_statuses_id_seq; Type: SEQUENCE OWNED BY; Schema: health; Owner: -
--

ALTER SEQUENCE health.candidate_statuses_id_seq OWNED BY health.candidate_statuses.id;
...
--
-- Name: candidate_status_relationships; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.candidate_status_relationships (
    id bigint NOT NULL,
    current_candidate_status_id bigint NOT NULL,
    next_candidate_status_id bigint NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
...
--
-- Name: candidate_status_relationships_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.candidate_status_relationships_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_status_relationships_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.candidate_status_relationships_id_seq OWNED BY public.candidate_status_relationships.id;


--
-- Name: candidate_statuses; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: candidate_statuses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: candidate_statuses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: aggregator_capabilities id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".aggregator_capabilities ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".aggregator_capabilities_id_seq'::regclass);


--
-- Name: audits id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".audits ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".audits_id_seq'::regclass);


--
-- Name: authors id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".authors ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".authors_id_seq'::regclass);


--
-- Name: building_block_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".building_block_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".building_block_descriptions_id_seq'::regclass);


--
-- Name: building_blocks id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".building_blocks ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".building_blocks_id_seq'::regclass);


--
-- Name: candidate_datasets id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_datasets ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".candidate_datasets_id_seq'::regclass);


--
-- Name: candidate_organizations id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_organizations ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".candidate_organizations_id_seq'::regclass);


--
-- Name: candidate_products id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_products ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".candidate_products_id_seq'::regclass);


--
-- Name: candidate_resources id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_resources ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".candidate_resources_id_seq'::regclass);


--
-- Name: candidate_resources_countries id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_resources_countries ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".candidate_resources_countries_id_seq'::regclass);


--
-- Name: candidate_roles id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_roles ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".candidate_roles_id_seq'::regclass);


--
-- Name: candidate_status_relationships id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_status_relationships ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".candidate_status_relationships_id_seq'::regclass);


--
-- Name: candidate_statuses id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_statuses ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".candidate_statuses_id_seq'::regclass);


--
-- Name: category_indicator_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".category_indicator_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".category_indicator_descriptions_id_seq'::regclass);


--
-- Name: category_indicators id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".category_indicators ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".category_indicators_id_seq'::regclass);


--
-- Name: chatbot_conversations id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".chatbot_conversations ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".chatbot_conversations_id_seq'::regclass);


--
-- Name: cities id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".cities ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".cities_id_seq'::regclass);


--
-- Name: ckeditor_assets id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".ckeditor_assets ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".ckeditor_assets_id_seq'::regclass);


--
-- Name: classifications id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".classifications ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".classifications_id_seq'::regclass);


--
-- Name: comments id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".comments ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".comments_id_seq'::regclass);


--
-- Name: contacts id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".contacts ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".contacts_id_seq'::regclass);


--
-- Name: countries id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".countries ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".countries_id_seq'::regclass);


--
-- Name: dataset_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".dataset_descriptions_id_seq'::regclass);


--
-- Name: dataset_sectors id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_sectors ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".dataset_sectors_id_seq'::regclass);


--
-- Name: dataset_sustainable_development_goals id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_sustainable_development_goals ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".dataset_sustainable_development_goals_id_seq'::regclass);


--
-- Name: datasets id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".datasets_id_seq'::regclass);


--
-- Name: datasets_countries id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets_countries ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".datasets_countries_id_seq'::regclass);


--
-- Name: datasets_origins id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets_origins ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".datasets_origins_id_seq'::regclass);


--
-- Name: deploys id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".deploys ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".deploys_id_seq'::regclass);


--
-- Name: dial_spreadsheet_data id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dial_spreadsheet_data ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".dial_spreadsheet_data_id_seq'::regclass);


--
-- Name: digital_principles id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".digital_principles ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".digital_principles_id_seq'::regclass);


--
-- Name: districts id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".districts ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".districts_id_seq'::regclass);


--
-- Name: endorsers id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".endorsers ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".endorsers_id_seq'::regclass);


--
-- Name: exchange_tenants id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".exchange_tenants ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".exchange_tenants_id_seq'::regclass);


--
-- Name: froala_images id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".froala_images ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".froala_images_id_seq'::regclass);


--
-- Name: glossaries id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".glossaries ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".glossaries_id_seq'::regclass);


--
-- Name: handbook_answers id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_answers ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".handbook_answers_id_seq'::regclass);


--
-- Name: handbook_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".handbook_descriptions_id_seq'::regclass);


--
-- Name: handbook_pages id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_pages ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".handbook_pages_id_seq'::regclass);


--
-- Name: handbook_questions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_questions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".handbook_questions_id_seq'::regclass);


--
-- Name: handbooks id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbooks ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".handbooks_id_seq'::regclass);


--
-- Name: messages id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".messages ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".messages_id_seq'::regclass);


--
-- Name: offices id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".offices ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".offices_id_seq'::regclass);


--
-- Name: operator_services id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".operator_services ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".operator_services_id_seq'::regclass);


--
-- Name: opportunities id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".opportunities_id_seq'::regclass);


--
-- Name: organization_contacts id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_contacts ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".organization_contacts_id_seq'::regclass);


--
-- Name: organization_datasets id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_datasets ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".organization_datasets_id_seq'::regclass);


--
-- Name: organization_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".organization_descriptions_id_seq'::regclass);


--
-- Name: organization_products id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_products ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".organization_products_id_seq'::regclass);


--
-- Name: organizations id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".organizations_id_seq'::regclass);


--
-- Name: organizations_countries id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_countries ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".organizations_countries_id_seq'::regclass);


--
-- Name: organizations_resources id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_resources ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".organizations_resources_id_seq'::regclass);


--
-- Name: origins id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".origins ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".origins_id_seq'::regclass);


--
-- Name: page_contents id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".page_contents ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".page_contents_id_seq'::regclass);


--
-- Name: play_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".play_descriptions_id_seq'::regclass);


--
-- Name: play_move_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_move_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".play_move_descriptions_id_seq'::regclass);


--
-- Name: play_moves id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_moves ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".play_moves_id_seq'::regclass);


--
-- Name: play_moves_resources id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_moves_resources ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".play_moves_resources_id_seq'::regclass);


--
-- Name: playbook_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbook_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".playbook_descriptions_id_seq'::regclass);


--
-- Name: playbook_plays id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbook_plays ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".playbook_plays_id_seq'::regclass);


--
-- Name: playbooks id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbooks ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".playbooks_id_seq'::regclass);


--
-- Name: plays id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".plays_id_seq'::regclass);


--
-- Name: plays_building_blocks id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_building_blocks ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".plays_building_blocks_id_seq'::regclass);


--
-- Name: plays_products id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_products ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".plays_products_id_seq'::regclass);


--
-- Name: plays_subplays id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_subplays ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".plays_subplays_id_seq'::regclass);


--
-- Name: portal_views id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".portal_views ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".portal_views_id_seq'::regclass);


--
-- Name: principle_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".principle_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".principle_descriptions_id_seq'::regclass);


--
-- Name: product_building_blocks id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_building_blocks ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".product_building_blocks_id_seq'::regclass);


--
-- Name: product_classifications id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_classifications ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".product_classifications_id_seq'::regclass);


--
-- Name: product_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".product_descriptions_id_seq'::regclass);


--
-- Name: product_indicators id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_indicators ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".product_indicators_id_seq'::regclass);


--
-- Name: product_product_relationships id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_product_relationships ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".product_product_relationships_id_seq'::regclass);


--
-- Name: product_repositories id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_repositories ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".product_repositories_id_seq'::regclass);


--
-- Name: product_sectors id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_sectors ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".product_sectors_id_seq'::regclass);


--
-- Name: product_sustainable_development_goals id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_sustainable_development_goals ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".product_sustainable_development_goals_id_seq'::regclass);


--
-- Name: products id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".products_id_seq'::regclass);


--
-- Name: products_countries id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_countries ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".products_countries_id_seq'::regclass);


--
-- Name: products_endorsers id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_endorsers ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".products_endorsers_id_seq'::regclass);


--
-- Name: project_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".project_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".project_descriptions_id_seq'::regclass);


--
-- Name: projects id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".projects_id_seq'::regclass);


--
-- Name: projects_countries id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_countries ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".projects_countries_id_seq'::regclass);


--
-- Name: projects_digital_principles id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_digital_principles ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".projects_digital_principles_id_seq'::regclass);


--
-- Name: provinces id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".provinces ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".provinces_id_seq'::regclass);


--
-- Name: regions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".regions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".regions_id_seq'::regclass);


--
-- Name: resource_building_blocks id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_building_blocks ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".resource_building_blocks_id_seq'::regclass);


--
-- Name: resource_topic_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_topic_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".resource_topic_descriptions_id_seq'::regclass);


--
-- Name: resource_topics id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_topics ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".resource_topics_id_seq'::regclass);


--
-- Name: resource_types id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_types ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".resource_types_id_seq'::regclass);


--
-- Name: resources id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resources ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".resources_id_seq'::regclass);


--
-- Name: resources_use_cases id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resources_use_cases ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".resources_use_cases_id_seq'::regclass);


--
-- Name: rubric_categories id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".rubric_categories ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".rubric_categories_id_seq'::regclass);


--
-- Name: rubric_category_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".rubric_category_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".rubric_category_descriptions_id_seq'::regclass);


--
-- Name: sdg_targets id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sdg_targets ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".sdg_targets_id_seq'::regclass);


--
-- Name: sectors id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sectors ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".sectors_id_seq'::regclass);


--
-- Name: sessions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sessions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".sessions_id_seq'::regclass);


--
-- Name: settings id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".settings ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".settings_id_seq'::regclass);


--
-- Name: site_settings id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".site_settings ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".site_settings_id_seq'::regclass);


--
-- Name: software_categories id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".software_categories ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".software_categories_id_seq'::regclass);


--
-- Name: software_features id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".software_features ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".software_features_id_seq'::regclass);


--
-- Name: starred_objects id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".starred_objects ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".starred_objects_id_seq'::regclass);


--
-- Name: stylesheets id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".stylesheets ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".stylesheets_id_seq'::regclass);


--
-- Name: sustainable_development_goals id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sustainable_development_goals ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".sustainable_development_goals_id_seq'::regclass);


--
-- Name: tag_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".tag_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".tag_descriptions_id_seq'::regclass);


--
-- Name: tags id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".tags ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".tags_id_seq'::regclass);


--
-- Name: task_tracker_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".task_tracker_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".task_tracker_descriptions_id_seq'::regclass);


--
-- Name: task_trackers id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".task_trackers ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".task_trackers_id_seq'::regclass);


--
-- Name: tenant_sync_configurations id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".tenant_sync_configurations ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".tenant_sync_configurations_id_seq'::regclass);


--
-- Name: use_case_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".use_case_descriptions_id_seq'::regclass);


--
-- Name: use_case_headers id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_headers ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".use_case_headers_id_seq'::regclass);


--
-- Name: use_case_step_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_step_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".use_case_step_descriptions_id_seq'::regclass);


--
-- Name: use_case_steps id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".use_case_steps_id_seq'::regclass);


--
-- Name: use_case_steps_building_blocks id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_building_blocks ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".use_case_steps_building_blocks_id_seq'::regclass);


--
-- Name: use_case_steps_datasets id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_datasets ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".use_case_steps_datasets_id_seq'::regclass);


--
-- Name: use_case_steps_products id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_products ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".use_case_steps_products_id_seq'::regclass);


--
-- Name: use_cases id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_cases ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".use_cases_id_seq'::regclass);


--
-- Name: user_events id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".user_events ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".user_events_id_seq'::regclass);


--
-- Name: user_messages id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".user_messages ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".user_messages_id_seq'::regclass);


--
-- Name: users id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".users ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".users_id_seq'::regclass);


--
-- Name: workflow_descriptions id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".workflow_descriptions ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".workflow_descriptions_id_seq'::regclass);


--
-- Name: workflows id; Type: DEFAULT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".workflows ALTER COLUMN id SET DEFAULT nextval('"exchange-tenant".workflows_id_seq'::regclass);
...
--
-- Name: candidate_status_relationships id; Type: DEFAULT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_status_relationships ALTER COLUMN id SET DEFAULT nextval('health.candidate_status_relationships_id_seq'::regclass);


--
-- Name: candidate_statuses id; Type: DEFAULT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_statuses ALTER COLUMN id SET DEFAULT nextval('health.candidate_statuses_id_seq'::regclass);
...
--
-- Name: candidate_status_relationships id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.candidate_status_relationships ALTER COLUMN id SET DEFAULT nextval('public.candidate_status_relationships_id_seq'::regclass);


--
-- Name: candidate_statuses id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: aggregator_capabilities aggregator_capabilities_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".aggregator_capabilities
    ADD CONSTRAINT aggregator_capabilities_pkey PRIMARY KEY (id);


--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".ar_internal_metadata
    ADD CONSTRAINT ar_internal_metadata_pkey PRIMARY KEY (key);


--
-- Name: audits audits_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".audits
    ADD CONSTRAINT audits_pkey PRIMARY KEY (id);


--
-- Name: authors authors_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".authors
    ADD CONSTRAINT authors_pkey PRIMARY KEY (id);


--
-- Name: building_block_descriptions building_block_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".building_block_descriptions
    ADD CONSTRAINT building_block_descriptions_pkey PRIMARY KEY (id);


--
-- Name: building_blocks building_blocks_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".building_blocks
    ADD CONSTRAINT building_blocks_pkey PRIMARY KEY (id);


--
-- Name: candidate_datasets candidate_datasets_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_datasets
    ADD CONSTRAINT candidate_datasets_pkey PRIMARY KEY (id);


--
-- Name: candidate_organizations candidate_organizations_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_organizations
    ADD CONSTRAINT candidate_organizations_pkey PRIMARY KEY (id);


--
-- Name: candidate_products candidate_products_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_products
    ADD CONSTRAINT candidate_products_pkey PRIMARY KEY (id);


--
-- Name: candidate_resources_countries candidate_resources_countries_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_resources_countries
    ADD CONSTRAINT candidate_resources_countries_pkey PRIMARY KEY (id);


--
-- Name: candidate_resources candidate_resources_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_resources
    ADD CONSTRAINT candidate_resources_pkey PRIMARY KEY (id);


--
-- Name: candidate_roles candidate_roles_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_roles
    ADD CONSTRAINT candidate_roles_pkey PRIMARY KEY (id);


--
-- Name: candidate_status_relationships candidate_status_relationships_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_status_relationships
    ADD CONSTRAINT candidate_status_relationships_pkey PRIMARY KEY (id);


--
-- Name: candidate_statuses candidate_statuses_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_statuses
    ADD CONSTRAINT candidate_statuses_pkey PRIMARY KEY (id);


--
-- Name: category_indicator_descriptions category_indicator_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".category_indicator_descriptions
    ADD CONSTRAINT category_indicator_descriptions_pkey PRIMARY KEY (id);


--
-- Name: category_indicators category_indicators_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".category_indicators
    ADD CONSTRAINT category_indicators_pkey PRIMARY KEY (id);


--
-- Name: chatbot_conversations chatbot_conversations_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".chatbot_conversations
    ADD CONSTRAINT chatbot_conversations_pkey PRIMARY KEY (id);


--
-- Name: cities cities_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".cities
    ADD CONSTRAINT cities_pkey PRIMARY KEY (id);


--
-- Name: ckeditor_assets ckeditor_assets_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".ckeditor_assets
    ADD CONSTRAINT ckeditor_assets_pkey PRIMARY KEY (id);


--
-- Name: classifications classifications_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".classifications
    ADD CONSTRAINT classifications_pkey PRIMARY KEY (id);


--
-- Name: comments comments_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".comments
    ADD CONSTRAINT comments_pkey PRIMARY KEY (id);


--
-- Name: contacts contacts_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".contacts
    ADD CONSTRAINT contacts_pkey PRIMARY KEY (id);


--
-- Name: countries countries_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".countries
    ADD CONSTRAINT countries_pkey PRIMARY KEY (id);


--
-- Name: dataset_descriptions dataset_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_descriptions
    ADD CONSTRAINT dataset_descriptions_pkey PRIMARY KEY (id);


--
-- Name: dataset_sectors dataset_sectors_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_sectors
    ADD CONSTRAINT dataset_sectors_pkey PRIMARY KEY (id);


--
-- Name: dataset_sustainable_development_goals dataset_sustainable_development_goals_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_sustainable_development_goals
    ADD CONSTRAINT dataset_sustainable_development_goals_pkey PRIMARY KEY (id);


--
-- Name: datasets_countries datasets_countries_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets_countries
    ADD CONSTRAINT datasets_countries_pkey PRIMARY KEY (id);


--
-- Name: datasets_origins datasets_origins_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets_origins
    ADD CONSTRAINT datasets_origins_pkey PRIMARY KEY (id);


--
-- Name: datasets datasets_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets
    ADD CONSTRAINT datasets_pkey PRIMARY KEY (id);


--
-- Name: deploys deploys_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".deploys
    ADD CONSTRAINT deploys_pkey PRIMARY KEY (id);


--
-- Name: dial_spreadsheet_data dial_spreadsheet_data_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dial_spreadsheet_data
    ADD CONSTRAINT dial_spreadsheet_data_pkey PRIMARY KEY (id);


--
-- Name: digital_principles digital_principles_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".digital_principles
    ADD CONSTRAINT digital_principles_pkey PRIMARY KEY (id);


--
-- Name: districts districts_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".districts
    ADD CONSTRAINT districts_pkey PRIMARY KEY (id);


--
-- Name: endorsers endorsers_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".endorsers
    ADD CONSTRAINT endorsers_pkey PRIMARY KEY (id);


--
-- Name: exchange_tenants exchange_tenants_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".exchange_tenants
    ADD CONSTRAINT exchange_tenants_pkey PRIMARY KEY (id);


--
-- Name: froala_images froala_images_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".froala_images
    ADD CONSTRAINT froala_images_pkey PRIMARY KEY (id);


--
-- Name: glossaries glossaries_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".glossaries
    ADD CONSTRAINT glossaries_pkey PRIMARY KEY (id);


--
-- Name: handbook_answers handbook_answers_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_answers
    ADD CONSTRAINT handbook_answers_pkey PRIMARY KEY (id);


--
-- Name: handbook_descriptions handbook_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_descriptions
    ADD CONSTRAINT handbook_descriptions_pkey PRIMARY KEY (id);


--
-- Name: handbook_pages handbook_pages_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_pages
    ADD CONSTRAINT handbook_pages_pkey PRIMARY KEY (id);


--
-- Name: handbook_questions handbook_questions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_questions
    ADD CONSTRAINT handbook_questions_pkey PRIMARY KEY (id);


--
-- Name: handbooks handbooks_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbooks
    ADD CONSTRAINT handbooks_pkey PRIMARY KEY (id);


--
-- Name: messages messages_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".messages
    ADD CONSTRAINT messages_pkey PRIMARY KEY (id);


--
-- Name: offices offices_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".offices
    ADD CONSTRAINT offices_pkey PRIMARY KEY (id);


--
-- Name: operator_services operator_services_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".operator_services
    ADD CONSTRAINT operator_services_pkey PRIMARY KEY (id);


--
-- Name: opportunities opportunities_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities
    ADD CONSTRAINT opportunities_pkey PRIMARY KEY (id);


--
-- Name: organization_contacts organization_contacts_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_contacts
    ADD CONSTRAINT organization_contacts_pkey PRIMARY KEY (id);


--
-- Name: organization_datasets organization_datasets_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_datasets
    ADD CONSTRAINT organization_datasets_pkey PRIMARY KEY (id);


--
-- Name: organization_descriptions organization_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_descriptions
    ADD CONSTRAINT organization_descriptions_pkey PRIMARY KEY (id);


--
-- Name: organization_products organization_products_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_products
    ADD CONSTRAINT organization_products_pkey PRIMARY KEY (id);


--
-- Name: organizations_countries organizations_countries_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_countries
    ADD CONSTRAINT organizations_countries_pkey PRIMARY KEY (id);


--
-- Name: organizations organizations_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations
    ADD CONSTRAINT organizations_pkey PRIMARY KEY (id);


--
-- Name: organizations_resources organizations_resources_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_resources
    ADD CONSTRAINT organizations_resources_pkey PRIMARY KEY (id);


--
-- Name: origins origins_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".origins
    ADD CONSTRAINT origins_pkey PRIMARY KEY (id);


--
-- Name: page_contents page_contents_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".page_contents
    ADD CONSTRAINT page_contents_pkey PRIMARY KEY (id);


--
-- Name: play_descriptions play_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_descriptions
    ADD CONSTRAINT play_descriptions_pkey PRIMARY KEY (id);


--
-- Name: play_move_descriptions play_move_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_move_descriptions
    ADD CONSTRAINT play_move_descriptions_pkey PRIMARY KEY (id);


--
-- Name: play_moves play_moves_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_moves
    ADD CONSTRAINT play_moves_pkey PRIMARY KEY (id);


--
-- Name: play_moves_resources play_moves_resources_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_moves_resources
    ADD CONSTRAINT play_moves_resources_pkey PRIMARY KEY (id);


--
-- Name: playbook_descriptions playbook_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbook_descriptions
    ADD CONSTRAINT playbook_descriptions_pkey PRIMARY KEY (id);


--
-- Name: playbook_plays playbook_plays_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbook_plays
    ADD CONSTRAINT playbook_plays_pkey PRIMARY KEY (id);


--
-- Name: playbooks playbooks_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbooks
    ADD CONSTRAINT playbooks_pkey PRIMARY KEY (id);


--
-- Name: plays_building_blocks plays_building_blocks_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_building_blocks
    ADD CONSTRAINT plays_building_blocks_pkey PRIMARY KEY (id);


--
-- Name: plays plays_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays
    ADD CONSTRAINT plays_pkey PRIMARY KEY (id);


--
-- Name: plays_products plays_products_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_products
    ADD CONSTRAINT plays_products_pkey PRIMARY KEY (id);


--
-- Name: plays_subplays plays_subplays_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_subplays
    ADD CONSTRAINT plays_subplays_pkey PRIMARY KEY (id);


--
-- Name: portal_views portal_views_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".portal_views
    ADD CONSTRAINT portal_views_pkey PRIMARY KEY (id);


--
-- Name: principle_descriptions principle_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".principle_descriptions
    ADD CONSTRAINT principle_descriptions_pkey PRIMARY KEY (id);


--
-- Name: product_building_blocks product_building_blocks_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_building_blocks
    ADD CONSTRAINT product_building_blocks_pkey PRIMARY KEY (id);


--
-- Name: product_classifications product_classifications_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_classifications
    ADD CONSTRAINT product_classifications_pkey PRIMARY KEY (id);


--
-- Name: product_descriptions product_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_descriptions
    ADD CONSTRAINT product_descriptions_pkey PRIMARY KEY (id);


--
-- Name: product_indicators product_indicators_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_indicators
    ADD CONSTRAINT product_indicators_pkey PRIMARY KEY (id);


--
-- Name: product_product_relationships product_product_relationships_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_product_relationships
    ADD CONSTRAINT product_product_relationships_pkey PRIMARY KEY (id);


--
-- Name: product_repositories product_repositories_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_repositories
    ADD CONSTRAINT product_repositories_pkey PRIMARY KEY (id);


--
-- Name: product_sectors product_sectors_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_sectors
    ADD CONSTRAINT product_sectors_pkey PRIMARY KEY (id);


--
-- Name: product_sustainable_development_goals product_sustainable_development_goals_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_sustainable_development_goals
    ADD CONSTRAINT product_sustainable_development_goals_pkey PRIMARY KEY (id);


--
-- Name: products_countries products_countries_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_countries
    ADD CONSTRAINT products_countries_pkey PRIMARY KEY (id);


--
-- Name: products_endorsers products_endorsers_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_endorsers
    ADD CONSTRAINT products_endorsers_pkey PRIMARY KEY (id);


--
-- Name: products products_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products
    ADD CONSTRAINT products_pkey PRIMARY KEY (id);


--
-- Name: project_descriptions project_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".project_descriptions
    ADD CONSTRAINT project_descriptions_pkey PRIMARY KEY (id);


--
-- Name: projects_countries projects_countries_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_countries
    ADD CONSTRAINT projects_countries_pkey PRIMARY KEY (id);


--
-- Name: projects_digital_principles projects_digital_principles_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_digital_principles
    ADD CONSTRAINT projects_digital_principles_pkey PRIMARY KEY (id);


--
-- Name: projects projects_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects
    ADD CONSTRAINT projects_pkey PRIMARY KEY (id);


--
-- Name: provinces provinces_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".provinces
    ADD CONSTRAINT provinces_pkey PRIMARY KEY (id);


--
-- Name: regions regions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".regions
    ADD CONSTRAINT regions_pkey PRIMARY KEY (id);


--
-- Name: resource_building_blocks resource_building_blocks_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_building_blocks
    ADD CONSTRAINT resource_building_blocks_pkey PRIMARY KEY (id);


--
-- Name: resource_topic_descriptions resource_topic_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_topic_descriptions
    ADD CONSTRAINT resource_topic_descriptions_pkey PRIMARY KEY (id);


--
-- Name: resource_topics resource_topics_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_topics
    ADD CONSTRAINT resource_topics_pkey PRIMARY KEY (id);


--
-- Name: resource_types resource_types_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_types
    ADD CONSTRAINT resource_types_pkey PRIMARY KEY (id);


--
-- Name: resources resources_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resources
    ADD CONSTRAINT resources_pkey PRIMARY KEY (id);


--
-- Name: resources_use_cases resources_use_cases_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resources_use_cases
    ADD CONSTRAINT resources_use_cases_pkey PRIMARY KEY (id);


--
-- Name: rubric_categories rubric_categories_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".rubric_categories
    ADD CONSTRAINT rubric_categories_pkey PRIMARY KEY (id);


--
-- Name: rubric_category_descriptions rubric_category_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".rubric_category_descriptions
    ADD CONSTRAINT rubric_category_descriptions_pkey PRIMARY KEY (id);


--
-- Name: schema_migrations schema_migrations_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".schema_migrations
    ADD CONSTRAINT schema_migrations_pkey PRIMARY KEY (version);


--
-- Name: sdg_targets sdg_targets_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sdg_targets
    ADD CONSTRAINT sdg_targets_pkey PRIMARY KEY (id);


--
-- Name: sectors sectors_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sectors
    ADD CONSTRAINT sectors_pkey PRIMARY KEY (id);


--
-- Name: sessions sessions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sessions
    ADD CONSTRAINT sessions_pkey PRIMARY KEY (id);


--
-- Name: settings settings_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".settings
    ADD CONSTRAINT settings_pkey PRIMARY KEY (id);


--
-- Name: site_settings site_settings_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".site_settings
    ADD CONSTRAINT site_settings_pkey PRIMARY KEY (id);


--
-- Name: software_categories software_categories_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".software_categories
    ADD CONSTRAINT software_categories_pkey PRIMARY KEY (id);


--
-- Name: software_features software_features_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".software_features
    ADD CONSTRAINT software_features_pkey PRIMARY KEY (id);


--
-- Name: starred_objects starred_objects_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".starred_objects
    ADD CONSTRAINT starred_objects_pkey PRIMARY KEY (id);


--
-- Name: stylesheets stylesheets_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".stylesheets
    ADD CONSTRAINT stylesheets_pkey PRIMARY KEY (id);


--
-- Name: sustainable_development_goals sustainable_development_goals_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sustainable_development_goals
    ADD CONSTRAINT sustainable_development_goals_pkey PRIMARY KEY (id);


--
-- Name: tag_descriptions tag_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".tag_descriptions
    ADD CONSTRAINT tag_descriptions_pkey PRIMARY KEY (id);


--
-- Name: tags tags_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".tags
    ADD CONSTRAINT tags_pkey PRIMARY KEY (id);


--
-- Name: task_tracker_descriptions task_tracker_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".task_tracker_descriptions
    ADD CONSTRAINT task_tracker_descriptions_pkey PRIMARY KEY (id);


--
-- Name: task_trackers task_trackers_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".task_trackers
    ADD CONSTRAINT task_trackers_pkey PRIMARY KEY (id);


--
-- Name: tenant_sync_configurations tenant_sync_configurations_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".tenant_sync_configurations
    ADD CONSTRAINT tenant_sync_configurations_pkey PRIMARY KEY (id);


--
-- Name: use_case_descriptions use_case_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_descriptions
    ADD CONSTRAINT use_case_descriptions_pkey PRIMARY KEY (id);


--
-- Name: use_case_headers use_case_headers_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_headers
    ADD CONSTRAINT use_case_headers_pkey PRIMARY KEY (id);


--
-- Name: use_case_step_descriptions use_case_step_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_step_descriptions
    ADD CONSTRAINT use_case_step_descriptions_pkey PRIMARY KEY (id);


--
-- Name: use_case_steps_building_blocks use_case_steps_building_blocks_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_building_blocks
    ADD CONSTRAINT use_case_steps_building_blocks_pkey PRIMARY KEY (id);


--
-- Name: use_case_steps_datasets use_case_steps_datasets_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_datasets
    ADD CONSTRAINT use_case_steps_datasets_pkey PRIMARY KEY (id);


--
-- Name: use_case_steps use_case_steps_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps
    ADD CONSTRAINT use_case_steps_pkey PRIMARY KEY (id);


--
-- Name: use_case_steps_products use_case_steps_products_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_products
    ADD CONSTRAINT use_case_steps_products_pkey PRIMARY KEY (id);


--
-- Name: use_cases use_cases_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_cases
    ADD CONSTRAINT use_cases_pkey PRIMARY KEY (id);


--
-- Name: user_events user_events_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".user_events
    ADD CONSTRAINT user_events_pkey PRIMARY KEY (id);


--
-- Name: user_messages user_messages_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".user_messages
    ADD CONSTRAINT user_messages_pkey PRIMARY KEY (id);


--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".users
    ADD CONSTRAINT users_pkey PRIMARY KEY (id);


--
-- Name: workflow_descriptions workflow_descriptions_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".workflow_descriptions
    ADD CONSTRAINT workflow_descriptions_pkey PRIMARY KEY (id);


--
-- Name: workflows workflows_pkey; Type: CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".workflows
...
--
-- Name: candidate_status_relationships candidate_status_relationships_pkey; Type: CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_status_relationships
    ADD CONSTRAINT candidate_status_relationships_pkey PRIMARY KEY (id);


--
-- Name: candidate_statuses candidate_statuses_pkey; Type: CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_statuses
    ADD CONSTRAINT candidate_statuses_pkey PRIMARY KEY (id);
...
--
-- Name: candidate_status_relationships candidate_status_relationships_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: candidate_statuses candidate_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agg_cap_operator_capability_index; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX agg_cap_operator_capability_index ON "exchange-tenant".aggregator_capabilities USING btree (aggregator_id, operator_services_id, capability);


--
-- Name: associated_index; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX associated_index ON "exchange-tenant".audits USING btree (associated_type, associated_id);


--
-- Name: auditable_index; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX auditable_index ON "exchange-tenant".audits USING btree (action, id, version);


--
-- Name: authors_unique_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX authors_unique_slug ON "exchange-tenant".authors USING btree (slug);


--
-- Name: bbs_plays_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX bbs_plays_idx ON "exchange-tenant".plays_building_blocks USING btree (building_block_id, play_id);


--
-- Name: bbs_workflows; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX bbs_workflows ON "exchange-tenant".workflows_building_blocks USING btree (building_block_id, workflow_id);


--
-- Name: block_prods; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX block_prods ON "exchange-tenant".product_building_blocks USING btree (building_block_id, product_id);


--
-- Name: building_blocks_use_case_steps_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX building_blocks_use_case_steps_idx ON "exchange-tenant".use_case_steps_building_blocks USING btree (building_block_id, use_case_step_id);


--
-- Name: candidate_resources_countries_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX candidate_resources_countries_idx ON "exchange-tenant".candidate_resources_countries USING btree (candidate_resource_id, country_id);


--
-- Name: candidate_roles_unique_fields; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX candidate_roles_unique_fields ON "exchange-tenant".candidate_roles USING btree (email, roles, organization_id, product_id);


--
-- Name: candidate_status_relationships_main_index; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX candidate_status_relationships_main_index ON "exchange-tenant".candidate_status_relationships USING btree (current_candidate_status_id, next_candidate_status_id);


--
-- Name: candidate_status_relationships_reverse_index; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX candidate_status_relationships_reverse_index ON "exchange-tenant".candidate_status_relationships USING btree (next_candidate_status_id, current_candidate_status_id);


--
-- Name: classifications_products_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX classifications_products_idx ON "exchange-tenant".product_classifications USING btree (classification_id, product_id);


--
-- Name: countries_candidate_resources_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX countries_candidate_resources_idx ON "exchange-tenant".candidate_resources_countries USING btree (country_id, candidate_resource_id);


--
-- Name: countries_product_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX countries_product_idx ON "exchange-tenant".products_countries USING btree (country_id, product_id);


--
-- Name: dataset_sdg_index_on_sdg_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX dataset_sdg_index_on_sdg_id ON "exchange-tenant".dataset_sustainable_development_goals USING btree (sustainable_development_goal_id);


--
-- Name: datasets_use_case_steps_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX datasets_use_case_steps_idx ON "exchange-tenant".use_case_steps_datasets USING btree (dataset_id, use_case_step_id);


--
-- Name: index_aggregator_capabilities_on_aggregator_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_aggregator_capabilities_on_aggregator_id ON "exchange-tenant".aggregator_capabilities USING btree (aggregator_id);


--
-- Name: index_aggregator_capabilities_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_aggregator_capabilities_on_country_id ON "exchange-tenant".aggregator_capabilities USING btree (country_id);


--
-- Name: index_aggregator_capabilities_on_operator_services_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_aggregator_capabilities_on_operator_services_id ON "exchange-tenant".aggregator_capabilities USING btree (operator_services_id);


--
-- Name: index_audits_on_created_at; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_audits_on_created_at ON "exchange-tenant".audits USING btree (created_at);


--
-- Name: index_building_block_descriptions_on_building_block_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_building_block_descriptions_on_building_block_id ON "exchange-tenant".building_block_descriptions USING btree (building_block_id);


--
-- Name: index_building_blocks_on_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_building_blocks_on_slug ON "exchange-tenant".building_blocks USING btree (slug);


--
-- Name: index_candidate_contacts_on_candidate_id_and_contact_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_contacts_on_candidate_id_and_contact_id ON "exchange-tenant".candidate_organizations_contacts USING btree (candidate_organization_id, contact_id);


--
-- Name: index_candidate_contacts_on_contact_id_and_candidate_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_contacts_on_contact_id_and_candidate_id ON "exchange-tenant".candidate_organizations_contacts USING btree (contact_id, candidate_organization_id);


--
-- Name: index_candidate_datasets_on_approved_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_datasets_on_approved_by_id ON "exchange-tenant".candidate_datasets USING btree (approved_by_id);


--
-- Name: index_candidate_datasets_on_rejected_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_datasets_on_rejected_by_id ON "exchange-tenant".candidate_datasets USING btree (rejected_by_id);


--
-- Name: index_candidate_organizations_on_approved_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_organizations_on_approved_by_id ON "exchange-tenant".candidate_organizations USING btree (approved_by_id);


--
-- Name: index_candidate_organizations_on_rejected_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_organizations_on_rejected_by_id ON "exchange-tenant".candidate_organizations USING btree (rejected_by_id);


--
-- Name: index_candidate_products_on_approved_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_products_on_approved_by_id ON "exchange-tenant".candidate_products USING btree (approved_by_id);


--
-- Name: index_candidate_products_on_candidate_status_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_products_on_candidate_status_id ON "exchange-tenant".candidate_products USING btree (candidate_status_id);


--
-- Name: index_candidate_products_on_rejected_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_products_on_rejected_by_id ON "exchange-tenant".candidate_products USING btree (rejected_by_id);


--
-- Name: index_candidate_resources_on_approved_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_resources_on_approved_by_id ON "exchange-tenant".candidate_resources USING btree (approved_by_id);


--
-- Name: index_candidate_resources_on_rejected_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_resources_on_rejected_by_id ON "exchange-tenant".candidate_resources USING btree (rejected_by_id);


--
-- Name: index_candidate_roles_on_approved_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_roles_on_approved_by_id ON "exchange-tenant".candidate_roles USING btree (approved_by_id);


--
-- Name: index_candidate_roles_on_dataset_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_roles_on_dataset_id ON "exchange-tenant".candidate_roles USING btree (dataset_id);


--
-- Name: index_candidate_roles_on_rejected_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_candidate_roles_on_rejected_by_id ON "exchange-tenant".candidate_roles USING btree (rejected_by_id);


--
-- Name: index_category_indicator_descriptions_on_category_indicator_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_category_indicator_descriptions_on_category_indicator_id ON "exchange-tenant".category_indicator_descriptions USING btree (category_indicator_id);


--
-- Name: index_category_indicators_on_rubric_category_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_category_indicators_on_rubric_category_id ON "exchange-tenant".category_indicators USING btree (rubric_category_id);


--
-- Name: index_chatbot_conversations_on_user_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_chatbot_conversations_on_user_id ON "exchange-tenant".chatbot_conversations USING btree (user_id);


--
-- Name: index_cities_on_province_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_cities_on_province_id ON "exchange-tenant".cities USING btree (province_id);


--
-- Name: index_ckeditor_assets_on_type; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_ckeditor_assets_on_type ON "exchange-tenant".ckeditor_assets USING btree (type);


--
-- Name: index_contacts_on_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_contacts_on_slug ON "exchange-tenant".contacts USING btree (slug);


--
-- Name: index_dataset_descriptions_on_dataset_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_dataset_descriptions_on_dataset_id ON "exchange-tenant".dataset_descriptions USING btree (dataset_id);


--
-- Name: index_dataset_sectors_on_dataset_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_dataset_sectors_on_dataset_id ON "exchange-tenant".dataset_sectors USING btree (dataset_id);


--
-- Name: index_dataset_sectors_on_sector_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_dataset_sectors_on_sector_id ON "exchange-tenant".dataset_sectors USING btree (sector_id);


--
-- Name: index_dataset_sustainable_development_goals_on_dataset_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_dataset_sustainable_development_goals_on_dataset_id ON "exchange-tenant".dataset_sustainable_development_goals USING btree (dataset_id);


--
-- Name: index_datasets_countries_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_datasets_countries_on_country_id ON "exchange-tenant".datasets_countries USING btree (country_id);


--
-- Name: index_datasets_countries_on_dataset_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_datasets_countries_on_dataset_id ON "exchange-tenant".datasets_countries USING btree (dataset_id);


--
-- Name: index_datasets_origins_on_dataset_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_datasets_origins_on_dataset_id ON "exchange-tenant".datasets_origins USING btree (dataset_id);


--
-- Name: index_datasets_origins_on_origin_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_datasets_origins_on_origin_id ON "exchange-tenant".datasets_origins USING btree (origin_id);


--
-- Name: index_deploys_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_deploys_on_product_id ON "exchange-tenant".deploys USING btree (product_id);


--
-- Name: index_deploys_on_user_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_deploys_on_user_id ON "exchange-tenant".deploys USING btree (user_id);


--
-- Name: index_districts_on_province_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_districts_on_province_id ON "exchange-tenant".districts USING btree (province_id);


--
-- Name: index_handbook_answers_on_handbook_question_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_handbook_answers_on_handbook_question_id ON "exchange-tenant".handbook_answers USING btree (handbook_question_id);


--
-- Name: index_handbook_descriptions_on_handbook_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_handbook_descriptions_on_handbook_id ON "exchange-tenant".handbook_descriptions USING btree (handbook_id);


--
-- Name: index_handbook_pages_on_handbook_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_handbook_pages_on_handbook_id ON "exchange-tenant".handbook_pages USING btree (handbook_id);


--
-- Name: index_handbook_pages_on_handbook_questions_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_handbook_pages_on_handbook_questions_id ON "exchange-tenant".handbook_pages USING btree (handbook_questions_id);


--
-- Name: index_handbook_pages_on_parent_page_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_handbook_pages_on_parent_page_id ON "exchange-tenant".handbook_pages USING btree (parent_page_id);


--
-- Name: index_handbook_questions_on_handbook_page_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_handbook_questions_on_handbook_page_id ON "exchange-tenant".handbook_questions USING btree (handbook_page_id);


--
-- Name: index_messages_on_created_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_messages_on_created_by_id ON "exchange-tenant".messages USING btree (created_by_id);


--
-- Name: index_offices_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_offices_on_country_id ON "exchange-tenant".offices USING btree (country_id);


--
-- Name: index_offices_on_organization_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_offices_on_organization_id ON "exchange-tenant".offices USING btree (organization_id);


--
-- Name: index_offices_on_province_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_offices_on_province_id ON "exchange-tenant".offices USING btree (province_id);


--
-- Name: index_operator_services_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_operator_services_on_country_id ON "exchange-tenant".operator_services USING btree (country_id);


--
-- Name: index_opportunities_building_blocks_on_building_block_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_building_blocks_on_building_block_id ON "exchange-tenant".opportunities_building_blocks USING btree (building_block_id);


--
-- Name: index_opportunities_building_blocks_on_opportunity_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_building_blocks_on_opportunity_id ON "exchange-tenant".opportunities_building_blocks USING btree (opportunity_id);


--
-- Name: index_opportunities_countries_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_countries_on_country_id ON "exchange-tenant".opportunities_countries USING btree (country_id);


--
-- Name: index_opportunities_countries_on_opportunity_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_countries_on_opportunity_id ON "exchange-tenant".opportunities_countries USING btree (opportunity_id);


--
-- Name: index_opportunities_on_origin_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_on_origin_id ON "exchange-tenant".opportunities USING btree (origin_id);


--
-- Name: index_opportunities_organizations_on_opportunity_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_organizations_on_opportunity_id ON "exchange-tenant".opportunities_organizations USING btree (opportunity_id);


--
-- Name: index_opportunities_organizations_on_organization_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_organizations_on_organization_id ON "exchange-tenant".opportunities_organizations USING btree (organization_id);


--
-- Name: index_opportunities_sectors_on_opportunity_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_sectors_on_opportunity_id ON "exchange-tenant".opportunities_sectors USING btree (opportunity_id);


--
-- Name: index_opportunities_sectors_on_sector_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_sectors_on_sector_id ON "exchange-tenant".opportunities_sectors USING btree (sector_id);


--
-- Name: index_opportunities_use_cases_on_opportunity_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_use_cases_on_opportunity_id ON "exchange-tenant".opportunities_use_cases USING btree (opportunity_id);


--
-- Name: index_opportunities_use_cases_on_use_case_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_opportunities_use_cases_on_use_case_id ON "exchange-tenant".opportunities_use_cases USING btree (use_case_id);


--
-- Name: index_organization_datasets_on_dataset_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_organization_datasets_on_dataset_id ON "exchange-tenant".organization_datasets USING btree (dataset_id);


--
-- Name: index_organization_datasets_on_organization_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_organization_datasets_on_organization_id ON "exchange-tenant".organization_datasets USING btree (organization_id);


--
-- Name: index_organization_descriptions_on_organization_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_organization_descriptions_on_organization_id ON "exchange-tenant".organization_descriptions USING btree (organization_id);


--
-- Name: index_organization_products_on_organization_id_and_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_organization_products_on_organization_id_and_product_id ON "exchange-tenant".organization_products USING btree (organization_id, product_id);


--
-- Name: index_organization_products_on_product_id_and_organization_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_organization_products_on_product_id_and_organization_id ON "exchange-tenant".organization_products USING btree (product_id, organization_id);


--
-- Name: index_organizations_countries_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_organizations_countries_on_country_id ON "exchange-tenant".organizations_countries USING btree (country_id);


--
-- Name: index_organizations_countries_on_organization_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_organizations_countries_on_organization_id ON "exchange-tenant".organizations_countries USING btree (organization_id);


--
-- Name: index_organizations_on_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_organizations_on_slug ON "exchange-tenant".organizations USING btree (slug);


--
-- Name: index_origins_on_organization_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_origins_on_organization_id ON "exchange-tenant".origins USING btree (organization_id);


--
-- Name: index_page_contents_on_handbook_page_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_page_contents_on_handbook_page_id ON "exchange-tenant".page_contents USING btree (handbook_page_id);


--
-- Name: index_play_descriptions_on_play_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_play_descriptions_on_play_id ON "exchange-tenant".play_descriptions USING btree (play_id);


--
-- Name: index_play_move_descriptions_on_play_move_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_play_move_descriptions_on_play_move_id ON "exchange-tenant".play_move_descriptions USING btree (play_move_id);


--
-- Name: index_play_moves_on_play_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_play_moves_on_play_id ON "exchange-tenant".play_moves USING btree (play_id);


--
-- Name: index_play_moves_resources; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_play_moves_resources ON "exchange-tenant".play_moves_resources USING btree (play_move_id, resource_id);


--
-- Name: index_play_moves_resources_on_play_move_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_play_moves_resources_on_play_move_id ON "exchange-tenant".play_moves_resources USING btree (play_move_id);


--
-- Name: index_play_moves_resources_on_resource_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_play_moves_resources_on_resource_id ON "exchange-tenant".play_moves_resources USING btree (resource_id);


--
-- Name: index_playbook_descriptions_on_playbook_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_playbook_descriptions_on_playbook_id ON "exchange-tenant".playbook_descriptions USING btree (playbook_id);


--
-- Name: index_playbook_plays_on_play_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_playbook_plays_on_play_id ON "exchange-tenant".playbook_plays USING btree (play_id);


--
-- Name: index_playbook_plays_on_playbook_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_playbook_plays_on_playbook_id ON "exchange-tenant".playbook_plays USING btree (playbook_id);


--
-- Name: index_plays_building_blocks_on_building_block_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_plays_building_blocks_on_building_block_id ON "exchange-tenant".plays_building_blocks USING btree (building_block_id);


--
-- Name: index_plays_building_blocks_on_play_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_plays_building_blocks_on_play_id ON "exchange-tenant".plays_building_blocks USING btree (play_id);


--
-- Name: index_plays_products_on_play_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_plays_products_on_play_id ON "exchange-tenant".plays_products USING btree (play_id);


--
-- Name: index_plays_products_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_plays_products_on_product_id ON "exchange-tenant".plays_products USING btree (product_id);


--
-- Name: index_principle_descriptions_on_digital_principle_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_principle_descriptions_on_digital_principle_id ON "exchange-tenant".principle_descriptions USING btree (digital_principle_id);


--
-- Name: index_product_categories_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_categories_on_product_id ON "exchange-tenant".product_categories USING btree (product_id);


--
-- Name: index_product_categories_on_software_category_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_categories_on_software_category_id ON "exchange-tenant".product_categories USING btree (software_category_id);


--
-- Name: index_product_classifications_on_classification_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_classifications_on_classification_id ON "exchange-tenant".product_classifications USING btree (classification_id);


--
-- Name: index_product_classifications_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_classifications_on_product_id ON "exchange-tenant".product_classifications USING btree (product_id);


--
-- Name: index_product_descriptions_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_descriptions_on_product_id ON "exchange-tenant".product_descriptions USING btree (product_id);


--
-- Name: index_product_features_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_features_on_product_id ON "exchange-tenant".product_features USING btree (product_id);


--
-- Name: index_product_features_on_software_feature_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_features_on_software_feature_id ON "exchange-tenant".product_features USING btree (software_feature_id);


--
-- Name: index_product_indicators_on_category_indicator_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_indicators_on_category_indicator_id ON "exchange-tenant".product_indicators USING btree (category_indicator_id);


--
-- Name: index_product_indicators_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_indicators_on_product_id ON "exchange-tenant".product_indicators USING btree (product_id);


--
-- Name: index_product_repositories_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_repositories_on_product_id ON "exchange-tenant".product_repositories USING btree (product_id);


--
-- Name: index_product_sectors_on_product_id_and_sector_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_sectors_on_product_id_and_sector_id ON "exchange-tenant".product_sectors USING btree (product_id, sector_id);


--
-- Name: index_product_sectors_on_sector_id_and_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_product_sectors_on_sector_id_and_product_id ON "exchange-tenant".product_sectors USING btree (sector_id, product_id);


--
-- Name: index_products_endorsers_on_endorser_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_products_endorsers_on_endorser_id ON "exchange-tenant".products_endorsers USING btree (endorser_id);


--
-- Name: index_products_endorsers_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_products_endorsers_on_product_id ON "exchange-tenant".products_endorsers USING btree (product_id);


--
-- Name: index_products_on_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_products_on_slug ON "exchange-tenant".products USING btree (slug);


--
-- Name: index_products_resources_on_product_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_products_resources_on_product_id ON "exchange-tenant".products_resources USING btree (product_id);


--
-- Name: index_products_resources_on_resource_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_products_resources_on_resource_id ON "exchange-tenant".products_resources USING btree (resource_id);


--
-- Name: index_project_descriptions_on_project_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_project_descriptions_on_project_id ON "exchange-tenant".project_descriptions USING btree (project_id);


--
-- Name: index_projects_countries_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_projects_countries_on_country_id ON "exchange-tenant".projects_countries USING btree (country_id);


--
-- Name: index_projects_countries_on_project_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_projects_countries_on_project_id ON "exchange-tenant".projects_countries USING btree (project_id);


--
-- Name: index_projects_digital_principles_on_digital_principle_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_projects_digital_principles_on_digital_principle_id ON "exchange-tenant".projects_digital_principles USING btree (digital_principle_id);


--
-- Name: index_projects_digital_principles_on_project_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_projects_digital_principles_on_project_id ON "exchange-tenant".projects_digital_principles USING btree (project_id);


--
-- Name: index_projects_on_origin_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_projects_on_origin_id ON "exchange-tenant".projects USING btree (origin_id);


--
-- Name: index_provinces_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_provinces_on_country_id ON "exchange-tenant".provinces USING btree (country_id);


--
-- Name: index_regions_countries; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_regions_countries ON "exchange-tenant".regions_countries USING btree (region_id, country_id);


--
-- Name: index_regions_on_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_regions_on_slug ON "exchange-tenant".regions USING btree (slug);


--
-- Name: index_resource_building_blocks; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_resource_building_blocks ON "exchange-tenant".resource_building_blocks USING btree (resource_id, building_block_id);


--
-- Name: index_resource_building_blocks_on_building_block_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resource_building_blocks_on_building_block_id ON "exchange-tenant".resource_building_blocks USING btree (building_block_id);


--
-- Name: index_resource_building_blocks_on_resource_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resource_building_blocks_on_resource_id ON "exchange-tenant".resource_building_blocks USING btree (resource_id);


--
-- Name: index_resource_topic_descriptions_on_resource_topic_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resource_topic_descriptions_on_resource_topic_id ON "exchange-tenant".resource_topic_descriptions USING btree (resource_topic_id);


--
-- Name: index_resource_topics_on_parent_topic_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resource_topics_on_parent_topic_id ON "exchange-tenant".resource_topics USING btree (parent_topic_id);


--
-- Name: index_resource_topics_on_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_resource_topics_on_slug ON "exchange-tenant".resource_topics USING btree (slug);


--
-- Name: index_resources_authors_on_author_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resources_authors_on_author_id ON "exchange-tenant".resources_authors USING btree (author_id);


--
-- Name: index_resources_authors_on_resource_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resources_authors_on_resource_id ON "exchange-tenant".resources_authors USING btree (resource_id);


--
-- Name: index_resources_countries_on_country_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resources_countries_on_country_id ON "exchange-tenant".resources_countries USING btree (country_id);


--
-- Name: index_resources_countries_on_resource_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resources_countries_on_resource_id ON "exchange-tenant".resources_countries USING btree (resource_id);


--
-- Name: index_resources_on_organization_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resources_on_organization_id ON "exchange-tenant".resources USING btree (organization_id);


--
-- Name: index_resources_on_submitted_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resources_on_submitted_by_id ON "exchange-tenant".resources USING btree (submitted_by_id);


--
-- Name: index_resources_use_cases; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_resources_use_cases ON "exchange-tenant".resources_use_cases USING btree (resource_id, use_case_id);


--
-- Name: index_resources_use_cases_on_resource_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resources_use_cases_on_resource_id ON "exchange-tenant".resources_use_cases USING btree (resource_id);


--
-- Name: index_resources_use_cases_on_use_case_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_resources_use_cases_on_use_case_id ON "exchange-tenant".resources_use_cases USING btree (use_case_id);


--
-- Name: index_rubric_category_descriptions_on_rubric_category_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_rubric_category_descriptions_on_rubric_category_id ON "exchange-tenant".rubric_category_descriptions USING btree (rubric_category_id);


--
-- Name: index_sdgs_on_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_sdgs_on_slug ON "exchange-tenant".sustainable_development_goals USING btree (slug);


--
-- Name: index_sector_slug_unique; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_sector_slug_unique ON "exchange-tenant".sectors USING btree (slug, origin_id, parent_sector_id, locale);


--
-- Name: index_sectors_on_origin_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_sectors_on_origin_id ON "exchange-tenant".sectors USING btree (origin_id);


--
-- Name: index_sectors_on_parent_sector_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_sectors_on_parent_sector_id ON "exchange-tenant".sectors USING btree (parent_sector_id);


--
-- Name: index_sessions_on_session_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_sessions_on_session_id ON "exchange-tenant".sessions USING btree (session_id);


--
-- Name: index_sessions_on_updated_at; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_sessions_on_updated_at ON "exchange-tenant".sessions USING btree (updated_at);


--
-- Name: index_software_features_on_software_category_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_software_features_on_software_category_id ON "exchange-tenant".software_features USING btree (software_category_id);


--
-- Name: index_starred_object_record; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_starred_object_record ON "exchange-tenant".starred_objects USING btree (starred_object_type, starred_object_value, source_object_type, source_object_value);


--
-- Name: index_starred_objects_on_starred_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_starred_objects_on_starred_by_id ON "exchange-tenant".starred_objects USING btree (starred_by_id);


--
-- Name: index_tag_descriptions_on_tag_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_tag_descriptions_on_tag_id ON "exchange-tenant".tag_descriptions USING btree (tag_id);


--
-- Name: index_task_tracker_descriptions_on_task_tracker_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_task_tracker_descriptions_on_task_tracker_id ON "exchange-tenant".task_tracker_descriptions USING btree (task_tracker_id);


--
-- Name: index_use_case_descriptions_on_use_case_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_use_case_descriptions_on_use_case_id ON "exchange-tenant".use_case_descriptions USING btree (use_case_id);


--
-- Name: index_use_case_headers_on_use_case_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_use_case_headers_on_use_case_id ON "exchange-tenant".use_case_headers USING btree (use_case_id);


--
-- Name: index_use_case_step_descriptions_on_use_case_step_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_use_case_step_descriptions_on_use_case_step_id ON "exchange-tenant".use_case_step_descriptions USING btree (use_case_step_id);


--
-- Name: index_use_case_steps_on_use_case_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_use_case_steps_on_use_case_id ON "exchange-tenant".use_case_steps USING btree (use_case_id);


--
-- Name: index_use_cases_on_sector_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_use_cases_on_sector_id ON "exchange-tenant".use_cases USING btree (sector_id);


--
-- Name: index_user_messages_on_message_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_user_messages_on_message_id ON "exchange-tenant".user_messages USING btree (message_id);


--
-- Name: index_user_messages_on_received_by_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_user_messages_on_received_by_id ON "exchange-tenant".user_messages USING btree (received_by_id);


--
-- Name: index_users_on_authentication_token; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_users_on_authentication_token ON "exchange-tenant".users USING btree (authentication_token);


--
-- Name: index_users_on_confirmation_token; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_users_on_confirmation_token ON "exchange-tenant".users USING btree (confirmation_token);


--
-- Name: index_users_on_email; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_users_on_email ON "exchange-tenant".users USING btree (email);


--
-- Name: index_users_on_reset_password_token; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX index_users_on_reset_password_token ON "exchange-tenant".users USING btree (reset_password_token);


--
-- Name: index_workflow_descriptions_on_workflow_id; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX index_workflow_descriptions_on_workflow_id ON "exchange-tenant".workflow_descriptions USING btree (workflow_id);


--
-- Name: opportunities_unique_slug; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX opportunities_unique_slug ON "exchange-tenant".opportunities USING btree (slug);


--
-- Name: org_sectors; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX org_sectors ON "exchange-tenant".organizations_sectors USING btree (organization_id, sector_id);


--
-- Name: organizations_projects_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX organizations_projects_idx ON "exchange-tenant".projects_organizations USING btree (organization_id, project_id);


--
-- Name: organizations_resources_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX organizations_resources_idx ON "exchange-tenant".organizations_resources USING btree (organization_id, resource_id);


--
-- Name: origins_products_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX origins_products_idx ON "exchange-tenant".products_origins USING btree (origin_id, product_id);


--
-- Name: play_rel_index; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX play_rel_index ON "exchange-tenant".plays_subplays USING btree (parent_play_id, child_play_id);


--
-- Name: playbooks_sectors_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX playbooks_sectors_idx ON "exchange-tenant".playbooks_sectors USING btree (playbook_id, sector_id);


--
-- Name: plays_bbs_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX plays_bbs_idx ON "exchange-tenant".plays_building_blocks USING btree (play_id, building_block_id);


--
-- Name: plays_products_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX plays_products_idx ON "exchange-tenant".plays_products USING btree (play_id, product_id);


--
-- Name: prod_blocks; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX prod_blocks ON "exchange-tenant".product_building_blocks USING btree (product_id, building_block_id);


--
-- Name: prod_sdgs; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX prod_sdgs ON "exchange-tenant".product_sustainable_development_goals USING btree (product_id, sustainable_development_goal_id);


--
-- Name: product_countries_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX product_countries_idx ON "exchange-tenant".products_countries USING btree (product_id, country_id);


--
-- Name: product_rel_index; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX product_rel_index ON "exchange-tenant".product_product_relationships USING btree (from_product_id, to_product_id);


--
-- Name: products_classifications_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX products_classifications_idx ON "exchange-tenant".product_classifications USING btree (product_id, classification_id);


--
-- Name: products_origins_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX products_origins_idx ON "exchange-tenant".products_origins USING btree (product_id, origin_id);


--
-- Name: products_plays_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX products_plays_idx ON "exchange-tenant".plays_products USING btree (product_id, play_id);


--
-- Name: products_projects_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX products_projects_idx ON "exchange-tenant".projects_products USING btree (product_id, project_id);


--
-- Name: products_use_case_steps_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX products_use_case_steps_idx ON "exchange-tenant".use_case_steps_products USING btree (product_id, use_case_step_id);


--
-- Name: projects_organizations_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX projects_organizations_idx ON "exchange-tenant".projects_organizations USING btree (project_id, organization_id);


--
-- Name: projects_products_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX projects_products_idx ON "exchange-tenant".projects_products USING btree (project_id, product_id);


--
-- Name: projects_sdgs_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX projects_sdgs_idx ON "exchange-tenant".projects_sdgs USING btree (project_id, sdg_id);


--
-- Name: projects_sectors_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX projects_sectors_idx ON "exchange-tenant".projects_sectors USING btree (project_id, sector_id);


--
-- Name: resources_organizations_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX resources_organizations_idx ON "exchange-tenant".organizations_resources USING btree (resource_id, organization_id);


--
-- Name: sdgs_prods; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX sdgs_prods ON "exchange-tenant".product_sustainable_development_goals USING btree (sustainable_development_goal_id, product_id);


--
-- Name: sdgs_projects_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX sdgs_projects_idx ON "exchange-tenant".projects_sdgs USING btree (sdg_id, project_id);


--
-- Name: sdgs_usecases; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX sdgs_usecases ON "exchange-tenant".use_cases_sdg_targets USING btree (sdg_target_id, use_case_id);


--
-- Name: sector_orcs; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX sector_orcs ON "exchange-tenant".organizations_sectors USING btree (sector_id, organization_id);


--
-- Name: sectors_playbooks_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX sectors_playbooks_idx ON "exchange-tenant".playbooks_sectors USING btree (sector_id, playbook_id);


--
-- Name: sectors_projects_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX sectors_projects_idx ON "exchange-tenant".projects_sectors USING btree (sector_id, project_id);


--
-- Name: unique_on_resource_topic_id_and_locale; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX unique_on_resource_topic_id_and_locale ON "exchange-tenant".resource_topic_descriptions USING btree (resource_topic_id, locale);


--
-- Name: use_case_steps_building_blocks_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX use_case_steps_building_blocks_idx ON "exchange-tenant".use_case_steps_building_blocks USING btree (use_case_step_id, building_block_id);


--
-- Name: use_case_steps_datasets_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX use_case_steps_datasets_idx ON "exchange-tenant".use_case_steps_datasets USING btree (use_case_step_id, dataset_id);


--
-- Name: use_case_steps_products_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX use_case_steps_products_idx ON "exchange-tenant".use_case_steps_products USING btree (use_case_step_id, product_id);


--
-- Name: use_case_steps_workflows_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX use_case_steps_workflows_idx ON "exchange-tenant".use_case_steps_workflows USING btree (use_case_step_id, workflow_id);


--
-- Name: usecases_sdgs; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX usecases_sdgs ON "exchange-tenant".use_cases_sdg_targets USING btree (use_case_id, sdg_target_id);


--
-- Name: usecases_workflows; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX usecases_workflows ON "exchange-tenant".workflows_use_cases USING btree (use_case_id, workflow_id);


--
-- Name: user_index; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE INDEX user_index ON "exchange-tenant".audits USING btree (user_id, user_role);


--
-- Name: workflows_bbs; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX workflows_bbs ON "exchange-tenant".workflows_building_blocks USING btree (workflow_id, building_block_id);


--
-- Name: workflows_use_case_steps_idx; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX workflows_use_case_steps_idx ON "exchange-tenant".use_case_steps_workflows USING btree (workflow_id, use_case_step_id);


--
-- Name: workflows_usecases; Type: INDEX; Schema: exchange-tenant; Owner: -
--

CREATE UNIQUE INDEX workflows_usecases ON "exchange-tenant".workflows_use_cases USING btree (workflow_id, use_case_id);
...
--
-- Name: candidate_status_relationships_main_index; Type: INDEX; Schema: health; Owner: -
--

CREATE UNIQUE INDEX candidate_status_relationships_main_index ON health.candidate_status_relationships USING btree (current_candidate_status_id, next_candidate_status_id);


--
-- Name: candidate_status_relationships_reverse_index; Type: INDEX; Schema: health; Owner: -
--

CREATE UNIQUE INDEX candidate_status_relationships_reverse_index ON health.candidate_status_relationships USING btree (next_candidate_status_id, current_candidate_status_id);
...
--
-- Name: index_candidate_products_on_candidate_status_id; Type: INDEX; Schema: health; Owner: -
--
...
--
-- Name: candidate_status_relationships_main_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX candidate_status_relationships_main_index ON public.candidate_status_relationships USING btree (current_candidate_status_id, next_candidate_status_id);


--
-- Name: candidate_status_relationships_reverse_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX candidate_status_relationships_reverse_index ON public.candidate_status_relationships USING btree (next_candidate_status_id, current_candidate_status_id);
...
--
-- Name: index_candidate_products_on_candidate_status_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_candidate_products_on_candidate_status_id ON public.candidate_products USING btree (candidate_status_id);
...
--
-- Name: plays_building_blocks bbs_plays_bb_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_building_blocks
    ADD CONSTRAINT bbs_plays_bb_fk FOREIGN KEY (building_block_id) REFERENCES "exchange-tenant".building_blocks(id);


--
-- Name: plays_building_blocks bbs_plays_play_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_building_blocks
    ADD CONSTRAINT bbs_plays_play_fk FOREIGN KEY (play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: candidate_resources candidate_resources_approved_by_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_resources
    ADD CONSTRAINT candidate_resources_approved_by_fk FOREIGN KEY (approved_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: candidate_resources_countries candidate_resources_countries_candidate_resources_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_resources_countries
    ADD CONSTRAINT candidate_resources_countries_candidate_resources_fk FOREIGN KEY (candidate_resource_id) REFERENCES "exchange-tenant".candidate_resources(id);


--
-- Name: candidate_resources_countries candidate_resources_countries_countries_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_resources_countries
    ADD CONSTRAINT candidate_resources_countries_countries_fk FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: candidate_resources candidate_resources_rejected_by_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_resources
    ADD CONSTRAINT candidate_resources_rejected_by_fk FOREIGN KEY (rejected_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: candidate_status_relationships candidate_status_relationships_current_candidate_status_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_status_relationships
    ADD CONSTRAINT candidate_status_relationships_current_candidate_status_fk FOREIGN KEY (current_candidate_status_id) REFERENCES "exchange-tenant".candidate_statuses(id);


--
-- Name: candidate_status_relationships candidate_status_relationships_next_candidate_status_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_status_relationships
    ADD CONSTRAINT candidate_status_relationships_next_candidate_status_fk FOREIGN KEY (next_candidate_status_id) REFERENCES "exchange-tenant".candidate_statuses(id);


--
-- Name: plays_subplays child_play_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_subplays
    ADD CONSTRAINT child_play_fk FOREIGN KEY (child_play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: districts fk_rails_002fc30497; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".districts
    ADD CONSTRAINT fk_rails_002fc30497 FOREIGN KEY (province_id) REFERENCES "exchange-tenant".provinces(id);


--
-- Name: offices fk_rails_0722c0e4f7; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".offices
    ADD CONSTRAINT fk_rails_0722c0e4f7 FOREIGN KEY (province_id) REFERENCES "exchange-tenant".provinces(id);


--
-- Name: handbook_descriptions fk_rails_08320ee34e; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_descriptions
    ADD CONSTRAINT fk_rails_08320ee34e FOREIGN KEY (handbook_id) REFERENCES "exchange-tenant".handbooks(id);


--
-- Name: playbook_descriptions fk_rails_08320ee34e; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbook_descriptions
    ADD CONSTRAINT fk_rails_08320ee34e FOREIGN KEY (playbook_id) REFERENCES "exchange-tenant".playbooks(id);


--
-- Name: offices fk_rails_08e10b87a1; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".offices
    ADD CONSTRAINT fk_rails_08e10b87a1 FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: sectors fk_rails_0c5b9fc834; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sectors
    ADD CONSTRAINT fk_rails_0c5b9fc834 FOREIGN KEY (origin_id) REFERENCES "exchange-tenant".origins(id);


--
-- Name: handbook_pages fk_rails_0d854afcc1; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_pages
    ADD CONSTRAINT fk_rails_0d854afcc1 FOREIGN KEY (handbook_id) REFERENCES "exchange-tenant".handbooks(id);


--
-- Name: datasets_origins fk_rails_1000d63cee; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets_origins
    ADD CONSTRAINT fk_rails_1000d63cee FOREIGN KEY (origin_id) REFERENCES "exchange-tenant".origins(id);


--
-- Name: product_categories fk_rails_156a781ad6; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_categories
    ADD CONSTRAINT fk_rails_156a781ad6 FOREIGN KEY (software_category_id) REFERENCES "exchange-tenant".software_categories(id);


--
-- Name: product_classifications fk_rails_16035b6309; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_classifications
    ADD CONSTRAINT fk_rails_16035b6309 FOREIGN KEY (classification_id) REFERENCES "exchange-tenant".classifications(id);


--
-- Name: chatbot_conversations fk_rails_17f52fc61f; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".chatbot_conversations
    ADD CONSTRAINT fk_rails_17f52fc61f FOREIGN KEY (user_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: use_case_steps fk_rails_1ab85a3bb6; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps
    ADD CONSTRAINT fk_rails_1ab85a3bb6 FOREIGN KEY (use_case_id) REFERENCES "exchange-tenant".use_cases(id);


--
-- Name: software_features fk_rails_1aba49ed7b; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".software_features
    ADD CONSTRAINT fk_rails_1aba49ed7b FOREIGN KEY (software_category_id) REFERENCES "exchange-tenant".software_categories(id);


--
-- Name: play_moves_resources fk_rails_1ba13f968c; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_moves_resources
    ADD CONSTRAINT fk_rails_1ba13f968c FOREIGN KEY (resource_id) REFERENCES "exchange-tenant".resources(id);


--
-- Name: candidate_roles fk_rails_1c91ae1dbd; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_roles
    ADD CONSTRAINT fk_rails_1c91ae1dbd FOREIGN KEY (approved_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: opportunities_organizations fk_rails_1e1b217e25; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_organizations
    ADD CONSTRAINT fk_rails_1e1b217e25 FOREIGN KEY (opportunity_id) REFERENCES "exchange-tenant".opportunities(id);


--
-- Name: building_block_descriptions fk_rails_1e30d5f2cb; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".building_block_descriptions
    ADD CONSTRAINT fk_rails_1e30d5f2cb FOREIGN KEY (building_block_id) REFERENCES "exchange-tenant".building_blocks(id);


--
-- Name: candidate_products fk_rails_1f7a4bef04; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_products
    ADD CONSTRAINT fk_rails_1f7a4bef04 FOREIGN KEY (approved_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: deploys fk_rails_1ffce4bab2; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".deploys
    ADD CONSTRAINT fk_rails_1ffce4bab2 FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: opportunities_building_blocks fk_rails_215b65662e; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_building_blocks
    ADD CONSTRAINT fk_rails_215b65662e FOREIGN KEY (opportunity_id) REFERENCES "exchange-tenant".opportunities(id);


--
-- Name: candidate_organizations fk_rails_246998b230; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_organizations
    ADD CONSTRAINT fk_rails_246998b230 FOREIGN KEY (rejected_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: candidate_products fk_rails_266c90eecf; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_products
    ADD CONSTRAINT fk_rails_266c90eecf FOREIGN KEY (candidate_status_id) REFERENCES "exchange-tenant".candidate_statuses(id) ON DELETE SET NULL;


--
-- Name: play_descriptions fk_rails_26dd7253a6; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_descriptions
    ADD CONSTRAINT fk_rails_26dd7253a6 FOREIGN KEY (play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: projects_digital_principles fk_rails_28bb8bf3f7; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_digital_principles
    ADD CONSTRAINT fk_rails_28bb8bf3f7 FOREIGN KEY (project_id) REFERENCES "exchange-tenant".projects(id);


--
-- Name: product_indicators fk_rails_2c154e19b9; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_indicators
    ADD CONSTRAINT fk_rails_2c154e19b9 FOREIGN KEY (category_indicator_id) REFERENCES "exchange-tenant".category_indicators(id);


--
-- Name: sectors fk_rails_2fafddb8c8; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".sectors
    ADD CONSTRAINT fk_rails_2fafddb8c8 FOREIGN KEY (parent_sector_id) REFERENCES "exchange-tenant".sectors(id);


--
-- Name: candidate_roles fk_rails_31a769978d; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_roles
    ADD CONSTRAINT fk_rails_31a769978d FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: organization_datasets fk_rails_37920930c1; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_datasets
    ADD CONSTRAINT fk_rails_37920930c1 FOREIGN KEY (dataset_id) REFERENCES "exchange-tenant".datasets(id);


--
-- Name: candidate_datasets fk_rails_393a906ad8; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_datasets
    ADD CONSTRAINT fk_rails_393a906ad8 FOREIGN KEY (rejected_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: candidate_roles fk_rails_3a1d782b99; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_roles
    ADD CONSTRAINT fk_rails_3a1d782b99 FOREIGN KEY (dataset_id) REFERENCES "exchange-tenant".datasets(id);


--
-- Name: organization_descriptions fk_rails_3a6b8edce9; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_descriptions
    ADD CONSTRAINT fk_rails_3a6b8edce9 FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: projects_digital_principles fk_rails_3eb4109c7d; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_digital_principles
    ADD CONSTRAINT fk_rails_3eb4109c7d FOREIGN KEY (digital_principle_id) REFERENCES "exchange-tenant".digital_principles(id);


--
-- Name: resources fk_rails_41c2c1001c; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resources
    ADD CONSTRAINT fk_rails_41c2c1001c FOREIGN KEY (submitted_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: projects fk_rails_45a5b9baa8; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects
    ADD CONSTRAINT fk_rails_45a5b9baa8 FOREIGN KEY (origin_id) REFERENCES "exchange-tenant".origins(id);


--
-- Name: tag_descriptions fk_rails_46e6dc893e; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".tag_descriptions
    ADD CONSTRAINT fk_rails_46e6dc893e FOREIGN KEY (tag_id) REFERENCES "exchange-tenant".tags(id);


--
-- Name: play_moves_resources fk_rails_48f1a17adf; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_moves_resources
    ADD CONSTRAINT fk_rails_48f1a17adf FOREIGN KEY (play_move_id) REFERENCES "exchange-tenant".play_moves(id);


--
-- Name: opportunities_countries fk_rails_49a664b2f7; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_countries
    ADD CONSTRAINT fk_rails_49a664b2f7 FOREIGN KEY (opportunity_id) REFERENCES "exchange-tenant".opportunities(id);


--
-- Name: candidate_roles fk_rails_4aa113bd52; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_roles
    ADD CONSTRAINT fk_rails_4aa113bd52 FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: plays_building_blocks fk_rails_4d36dad6d0; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_building_blocks
    ADD CONSTRAINT fk_rails_4d36dad6d0 FOREIGN KEY (building_block_id) REFERENCES "exchange-tenant".building_blocks(id);


--
-- Name: dataset_sectors fk_rails_4d5afa2af0; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_sectors
    ADD CONSTRAINT fk_rails_4d5afa2af0 FOREIGN KEY (dataset_id) REFERENCES "exchange-tenant".datasets(id);


--
-- Name: opportunities_sectors fk_rails_572c40b423; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_sectors
    ADD CONSTRAINT fk_rails_572c40b423 FOREIGN KEY (opportunity_id) REFERENCES "exchange-tenant".opportunities(id);


--
-- Name: operator_services fk_rails_5c31270ff7; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".operator_services
    ADD CONSTRAINT fk_rails_5c31270ff7 FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: opportunities fk_rails_5f8d9a4134; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities
    ADD CONSTRAINT fk_rails_5f8d9a4134 FOREIGN KEY (origin_id) REFERENCES "exchange-tenant".origins(id);


--
-- Name: user_messages fk_rails_60e38b1531; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".user_messages
    ADD CONSTRAINT fk_rails_60e38b1531 FOREIGN KEY (received_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: organizations_countries fk_rails_61354fe2dd; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_countries
    ADD CONSTRAINT fk_rails_61354fe2dd FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: dataset_descriptions fk_rails_6233152996; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_descriptions
    ADD CONSTRAINT fk_rails_6233152996 FOREIGN KEY (dataset_id) REFERENCES "exchange-tenant".datasets(id);


--
-- Name: offices fk_rails_63e101f453; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".offices
    ADD CONSTRAINT fk_rails_63e101f453 FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: handbook_pages fk_rails_6441d33616; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_pages
    ADD CONSTRAINT fk_rails_6441d33616 FOREIGN KEY (handbook_questions_id) REFERENCES "exchange-tenant".handbook_questions(id);


--
-- Name: task_tracker_descriptions fk_rails_64d4c2c34c; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".task_tracker_descriptions
    ADD CONSTRAINT fk_rails_64d4c2c34c FOREIGN KEY (task_tracker_id) REFERENCES "exchange-tenant".task_trackers(id);


--
-- Name: category_indicator_descriptions fk_rails_664858eff1; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".category_indicator_descriptions
    ADD CONSTRAINT fk_rails_664858eff1 FOREIGN KEY (category_indicator_id) REFERENCES "exchange-tenant".category_indicators(id);


--
-- Name: workflow_descriptions fk_rails_69d7772842; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".workflow_descriptions
    ADD CONSTRAINT fk_rails_69d7772842 FOREIGN KEY (workflow_id) REFERENCES "exchange-tenant".workflows(id);


--
-- Name: playbook_plays fk_rails_6b205fb457; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbook_plays
    ADD CONSTRAINT fk_rails_6b205fb457 FOREIGN KEY (playbook_id) REFERENCES "exchange-tenant".playbooks(id);


--
-- Name: datasets_countries fk_rails_6c45cff588; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets_countries
    ADD CONSTRAINT fk_rails_6c45cff588 FOREIGN KEY (dataset_id) REFERENCES "exchange-tenant".datasets(id);


--
-- Name: product_indicators fk_rails_721e0e4ba1; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_indicators
    ADD CONSTRAINT fk_rails_721e0e4ba1 FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: category_indicators fk_rails_72ff36837c; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".category_indicators
    ADD CONSTRAINT fk_rails_72ff36837c FOREIGN KEY (rubric_category_id) REFERENCES "exchange-tenant".rubric_categories(id);


--
-- Name: opportunities_use_cases fk_rails_74085c04cd; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_use_cases
    ADD CONSTRAINT fk_rails_74085c04cd FOREIGN KEY (opportunity_id) REFERENCES "exchange-tenant".opportunities(id);


--
-- Name: product_repositories fk_rails_76210df50f; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_repositories
    ADD CONSTRAINT fk_rails_76210df50f FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: projects_countries fk_rails_7940afe1fe; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_countries
    ADD CONSTRAINT fk_rails_7940afe1fe FOREIGN KEY (project_id) REFERENCES "exchange-tenant".projects(id);


--
-- Name: deploys fk_rails_7995634207; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".deploys
    ADD CONSTRAINT fk_rails_7995634207 FOREIGN KEY (user_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: use_case_step_descriptions fk_rails_7c6b0affba; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_step_descriptions
    ADD CONSTRAINT fk_rails_7c6b0affba FOREIGN KEY (use_case_step_id) REFERENCES "exchange-tenant".use_case_steps(id);


--
-- Name: rubric_category_descriptions fk_rails_7f79ec6842; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".rubric_category_descriptions
    ADD CONSTRAINT fk_rails_7f79ec6842 FOREIGN KEY (rubric_category_id) REFERENCES "exchange-tenant".rubric_categories(id);


--
-- Name: candidate_roles fk_rails_80a7b4e918; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_roles
    ADD CONSTRAINT fk_rails_80a7b4e918 FOREIGN KEY (rejected_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: opportunities_use_cases fk_rails_8350c2b67e; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_use_cases
    ADD CONSTRAINT fk_rails_8350c2b67e FOREIGN KEY (use_case_id) REFERENCES "exchange-tenant".use_cases(id);


--
-- Name: dataset_sectors fk_rails_8398ea4f75; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".dataset_sectors
    ADD CONSTRAINT fk_rails_8398ea4f75 FOREIGN KEY (sector_id) REFERENCES "exchange-tenant".sectors(id);


--
-- Name: projects_countries fk_rails_8fcd9cd60b; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_countries
    ADD CONSTRAINT fk_rails_8fcd9cd60b FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: product_features fk_rails_9019f50ede; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_features
    ADD CONSTRAINT fk_rails_9019f50ede FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: project_descriptions fk_rails_94cabf0709; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".project_descriptions
    ADD CONSTRAINT fk_rails_94cabf0709 FOREIGN KEY (project_id) REFERENCES "exchange-tenant".projects(id);


--
-- Name: use_case_descriptions fk_rails_94ea5f52ff; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_descriptions
    ADD CONSTRAINT fk_rails_94ea5f52ff FOREIGN KEY (use_case_id) REFERENCES "exchange-tenant".use_cases(id);


--
-- Name: opportunities_sectors fk_rails_973eb5ee0a; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_sectors
    ADD CONSTRAINT fk_rails_973eb5ee0a FOREIGN KEY (sector_id) REFERENCES "exchange-tenant".sectors(id);


--
-- Name: product_categories fk_rails_98a9a32a41; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_categories
    ADD CONSTRAINT fk_rails_98a9a32a41 FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: product_features fk_rails_9cbbc9970e; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_features
    ADD CONSTRAINT fk_rails_9cbbc9970e FOREIGN KEY (software_feature_id) REFERENCES "exchange-tenant".software_features(id);


--
-- Name: playbook_plays fk_rails_9d1a7ebfec; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbook_plays
    ADD CONSTRAINT fk_rails_9d1a7ebfec FOREIGN KEY (play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: products_endorsers fk_rails_9ebc436657; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_endorsers
    ADD CONSTRAINT fk_rails_9ebc436657 FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: play_move_descriptions fk_rails_9f26d2af9a; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_move_descriptions
    ADD CONSTRAINT fk_rails_9f26d2af9a FOREIGN KEY (play_move_id) REFERENCES "exchange-tenant".play_moves(id);


--
-- Name: aggregator_capabilities fk_rails_9fcd7b6d41; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".aggregator_capabilities
    ADD CONSTRAINT fk_rails_9fcd7b6d41 FOREIGN KEY (aggregator_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: organizations_countries fk_rails_a044fbacef; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_countries
    ADD CONSTRAINT fk_rails_a044fbacef FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: plays_products fk_rails_a0c000bc7e; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_products
    ADD CONSTRAINT fk_rails_a0c000bc7e FOREIGN KEY (play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: opportunities_organizations fk_rails_a699f03037; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_organizations
    ADD CONSTRAINT fk_rails_a699f03037 FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: products_endorsers fk_rails_a70896ae9e; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_endorsers
    ADD CONSTRAINT fk_rails_a70896ae9e FOREIGN KEY (endorser_id) REFERENCES "exchange-tenant".endorsers(id);


--
-- Name: plays_products fk_rails_a91dfa5414; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_products
    ADD CONSTRAINT fk_rails_a91dfa5414 FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: aggregator_capabilities fk_rails_aa5b2f5e59; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".aggregator_capabilities
    ADD CONSTRAINT fk_rails_aa5b2f5e59 FOREIGN KEY (operator_services_id) REFERENCES "exchange-tenant".operator_services(id);


--
-- Name: resource_topic_descriptions fk_rails_ae0fcdfa4b; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_topic_descriptions
    ADD CONSTRAINT fk_rails_ae0fcdfa4b FOREIGN KEY (resource_topic_id) REFERENCES "exchange-tenant".resource_topics(id);


--
-- Name: resource_topics fk_rails_af05504d30; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_topics
    ADD CONSTRAINT fk_rails_af05504d30 FOREIGN KEY (parent_topic_id) REFERENCES "exchange-tenant".resource_topics(id) ON DELETE SET NULL;


--
-- Name: resources_use_cases fk_rails_b312c98a0b; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resources_use_cases
    ADD CONSTRAINT fk_rails_b312c98a0b FOREIGN KEY (use_case_id) REFERENCES "exchange-tenant".use_cases(id);


--
-- Name: resources fk_rails_b7c74d1aaf; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resources
    ADD CONSTRAINT fk_rails_b7c74d1aaf FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id) ON DELETE SET NULL;


--
-- Name: opportunities_building_blocks fk_rails_bd7e32857c; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_building_blocks
    ADD CONSTRAINT fk_rails_bd7e32857c FOREIGN KEY (building_block_id) REFERENCES "exchange-tenant".building_blocks(id);


--
-- Name: product_descriptions fk_rails_c0bc9f9c8a; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_descriptions
    ADD CONSTRAINT fk_rails_c0bc9f9c8a FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: opportunities_countries fk_rails_c231d14160; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".opportunities_countries
    ADD CONSTRAINT fk_rails_c231d14160 FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: resources_use_cases fk_rails_c51465b571; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resources_use_cases
    ADD CONSTRAINT fk_rails_c51465b571 FOREIGN KEY (resource_id) REFERENCES "exchange-tenant".resources(id);


--
-- Name: resource_building_blocks fk_rails_c60c9cd0cf; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_building_blocks
    ADD CONSTRAINT fk_rails_c60c9cd0cf FOREIGN KEY (building_block_id) REFERENCES "exchange-tenant".building_blocks(id);


--
-- Name: organization_datasets fk_rails_c82c326076; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_datasets
    ADD CONSTRAINT fk_rails_c82c326076 FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: datasets_countries fk_rails_c8d14ec1b4; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets_countries
    ADD CONSTRAINT fk_rails_c8d14ec1b4 FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: messages fk_rails_cd133c6420; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".messages
    ADD CONSTRAINT fk_rails_cd133c6420 FOREIGN KEY (created_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: candidate_organizations fk_rails_d0cf117a92; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_organizations
    ADD CONSTRAINT fk_rails_d0cf117a92 FOREIGN KEY (approved_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: use_cases fk_rails_d2fed50240; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_cases
    ADD CONSTRAINT fk_rails_d2fed50240 FOREIGN KEY (sector_id) REFERENCES "exchange-tenant".sectors(id);


--
-- Name: product_classifications fk_rails_d5306b6dc7; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_classifications
    ADD CONSTRAINT fk_rails_d5306b6dc7 FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: resource_building_blocks fk_rails_d574f6d18b; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".resource_building_blocks
    ADD CONSTRAINT fk_rails_d574f6d18b FOREIGN KEY (resource_id) REFERENCES "exchange-tenant".resources(id);


--
-- Name: datasets_origins fk_rails_d604ea34b3; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".datasets_origins
    ADD CONSTRAINT fk_rails_d604ea34b3 FOREIGN KEY (dataset_id) REFERENCES "exchange-tenant".datasets(id);


--
-- Name: use_case_headers fk_rails_de4b7a8ac2; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_headers
    ADD CONSTRAINT fk_rails_de4b7a8ac2 FOREIGN KEY (use_case_id) REFERENCES "exchange-tenant".use_cases(id);


--
-- Name: play_moves fk_rails_e067d6a17d; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".play_moves
    ADD CONSTRAINT fk_rails_e067d6a17d FOREIGN KEY (play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: cities fk_rails_e0ef2914ca; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".cities
    ADD CONSTRAINT fk_rails_e0ef2914ca FOREIGN KEY (province_id) REFERENCES "exchange-tenant".provinces(id);


--
-- Name: user_messages fk_rails_e3535a825c; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".user_messages
    ADD CONSTRAINT fk_rails_e3535a825c FOREIGN KEY (message_id) REFERENCES "exchange-tenant".messages(id);


--
-- Name: handbook_pages fk_rails_edc977f5e7; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".handbook_pages
    ADD CONSTRAINT fk_rails_edc977f5e7 FOREIGN KEY (parent_page_id) REFERENCES "exchange-tenant".handbook_pages(id);


--
-- Name: aggregator_capabilities fk_rails_ee0ee7b8e7; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".aggregator_capabilities
    ADD CONSTRAINT fk_rails_ee0ee7b8e7 FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: candidate_products fk_rails_eed5af50b9; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_products
    ADD CONSTRAINT fk_rails_eed5af50b9 FOREIGN KEY (rejected_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: page_contents fk_rails_efc85b8fb4; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".page_contents
    ADD CONSTRAINT fk_rails_efc85b8fb4 FOREIGN KEY (handbook_page_id) REFERENCES "exchange-tenant".handbook_pages(id);


--
-- Name: principle_descriptions fk_rails_f1497d5d96; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".principle_descriptions
    ADD CONSTRAINT fk_rails_f1497d5d96 FOREIGN KEY (digital_principle_id) REFERENCES "exchange-tenant".digital_principles(id);


--
-- Name: starred_objects fk_rails_f18f95cc1b; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".starred_objects
    ADD CONSTRAINT fk_rails_f18f95cc1b FOREIGN KEY (starred_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: provinces fk_rails_f2ba72ccee; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".provinces
    ADD CONSTRAINT fk_rails_f2ba72ccee FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: candidate_datasets fk_rails_f460267737; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".candidate_datasets
    ADD CONSTRAINT fk_rails_f460267737 FOREIGN KEY (approved_by_id) REFERENCES "exchange-tenant".users(id);


--
-- Name: plays_building_blocks fk_rails_f47938caa0; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_building_blocks
    ADD CONSTRAINT fk_rails_f47938caa0 FOREIGN KEY (play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: product_product_relationships from_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_product_relationships
    ADD CONSTRAINT from_product_fk FOREIGN KEY (from_product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: organization_contacts organizations_contacts_contact_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_contacts
    ADD CONSTRAINT organizations_contacts_contact_fk FOREIGN KEY (contact_id) REFERENCES "exchange-tenant".contacts(id);


--
-- Name: organization_contacts organizations_contacts_organization_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_contacts
    ADD CONSTRAINT organizations_contacts_organization_fk FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: organization_products organizations_products_organization_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_products
    ADD CONSTRAINT organizations_products_organization_fk FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: organization_products organizations_products_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organization_products
    ADD CONSTRAINT organizations_products_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: organizations_resources organizations_resources_organization_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_resources
    ADD CONSTRAINT organizations_resources_organization_fk FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: organizations_resources organizations_resources_resource_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_resources
    ADD CONSTRAINT organizations_resources_resource_fk FOREIGN KEY (resource_id) REFERENCES "exchange-tenant".resources(id);


--
-- Name: organizations_sectors organizations_sectors_organization_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_sectors
    ADD CONSTRAINT organizations_sectors_organization_fk FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: organizations_sectors organizations_sectors_sector_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".organizations_sectors
    ADD CONSTRAINT organizations_sectors_sector_fk FOREIGN KEY (sector_id) REFERENCES "exchange-tenant".sectors(id);


--
-- Name: plays_subplays parent_play_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_subplays
    ADD CONSTRAINT parent_play_fk FOREIGN KEY (parent_play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: playbooks_sectors playbooks_sectors_playbook_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbooks_sectors
    ADD CONSTRAINT playbooks_sectors_playbook_fk FOREIGN KEY (playbook_id) REFERENCES "exchange-tenant".playbooks(id);


--
-- Name: playbooks_sectors playbooks_sectors_sector_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".playbooks_sectors
    ADD CONSTRAINT playbooks_sectors_sector_fk FOREIGN KEY (sector_id) REFERENCES "exchange-tenant".sectors(id);


--
-- Name: product_classifications product_classifications_classification_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_classifications
    ADD CONSTRAINT product_classifications_classification_fk FOREIGN KEY (classification_id) REFERENCES "exchange-tenant".classifications(id);


--
-- Name: product_classifications product_classifications_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_classifications
    ADD CONSTRAINT product_classifications_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: products_countries product_countries_country_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_countries
    ADD CONSTRAINT product_countries_country_fk FOREIGN KEY (country_id) REFERENCES "exchange-tenant".countries(id);


--
-- Name: products_countries product_countries_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_countries
    ADD CONSTRAINT product_countries_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: product_building_blocks products_building_blocks_building_block_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_building_blocks
    ADD CONSTRAINT products_building_blocks_building_block_fk FOREIGN KEY (building_block_id) REFERENCES "exchange-tenant".building_blocks(id);


--
-- Name: product_building_blocks products_building_blocks_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_building_blocks
    ADD CONSTRAINT products_building_blocks_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: products_origins products_origins_origin_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_origins
    ADD CONSTRAINT products_origins_origin_fk FOREIGN KEY (origin_id) REFERENCES "exchange-tenant".origins(id);


--
-- Name: products_origins products_origins_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".products_origins
    ADD CONSTRAINT products_origins_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: plays_products products_plays_play_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_products
    ADD CONSTRAINT products_plays_play_fk FOREIGN KEY (play_id) REFERENCES "exchange-tenant".plays(id);


--
-- Name: plays_products products_plays_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".plays_products
    ADD CONSTRAINT products_plays_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: product_sustainable_development_goals products_sdgs_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_sustainable_development_goals
    ADD CONSTRAINT products_sdgs_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: product_sustainable_development_goals products_sdgs_sdg_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_sustainable_development_goals
    ADD CONSTRAINT products_sdgs_sdg_fk FOREIGN KEY (sustainable_development_goal_id) REFERENCES "exchange-tenant".sustainable_development_goals(id);


--
-- Name: projects_organizations projects_organizations_organization_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_organizations
    ADD CONSTRAINT projects_organizations_organization_fk FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: projects_organizations projects_organizations_project_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_organizations
    ADD CONSTRAINT projects_organizations_project_fk FOREIGN KEY (project_id) REFERENCES "exchange-tenant".projects(id);


--
-- Name: projects_products projects_products_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_products
    ADD CONSTRAINT projects_products_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: projects_products projects_products_project_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_products
    ADD CONSTRAINT projects_products_project_fk FOREIGN KEY (project_id) REFERENCES "exchange-tenant".projects(id);


--
-- Name: projects_sdgs projects_sdgs_project_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_sdgs
    ADD CONSTRAINT projects_sdgs_project_fk FOREIGN KEY (project_id) REFERENCES "exchange-tenant".projects(id);


--
-- Name: projects_sdgs projects_sdgs_sdg_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_sdgs
    ADD CONSTRAINT projects_sdgs_sdg_fk FOREIGN KEY (sdg_id) REFERENCES "exchange-tenant".sustainable_development_goals(id);


--
-- Name: projects_sectors projects_sectors_project_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_sectors
    ADD CONSTRAINT projects_sectors_project_fk FOREIGN KEY (project_id) REFERENCES "exchange-tenant".projects(id);


--
-- Name: projects_sectors projects_sectors_sector_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".projects_sectors
    ADD CONSTRAINT projects_sectors_sector_fk FOREIGN KEY (sector_id) REFERENCES "exchange-tenant".sectors(id);


--
-- Name: product_product_relationships to_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".product_product_relationships
    ADD CONSTRAINT to_product_fk FOREIGN KEY (to_product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: use_case_steps_building_blocks use_case_steps_building_blocks_block_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_building_blocks
    ADD CONSTRAINT use_case_steps_building_blocks_block_fk FOREIGN KEY (building_block_id) REFERENCES "exchange-tenant".building_blocks(id);


--
-- Name: use_case_steps_building_blocks use_case_steps_building_blocks_step_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_building_blocks
    ADD CONSTRAINT use_case_steps_building_blocks_step_fk FOREIGN KEY (use_case_step_id) REFERENCES "exchange-tenant".use_case_steps(id);


--
-- Name: use_case_steps_datasets use_case_steps_datasets_dataset_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_datasets
    ADD CONSTRAINT use_case_steps_datasets_dataset_fk FOREIGN KEY (dataset_id) REFERENCES "exchange-tenant".datasets(id);


--
-- Name: use_case_steps_datasets use_case_steps_datasets_step_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_datasets
    ADD CONSTRAINT use_case_steps_datasets_step_fk FOREIGN KEY (use_case_step_id) REFERENCES "exchange-tenant".use_case_steps(id);


--
-- Name: use_case_steps_products use_case_steps_products_product_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_products
    ADD CONSTRAINT use_case_steps_products_product_fk FOREIGN KEY (product_id) REFERENCES "exchange-tenant".products(id);


--
-- Name: use_case_steps_products use_case_steps_products_step_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_products
    ADD CONSTRAINT use_case_steps_products_step_fk FOREIGN KEY (use_case_step_id) REFERENCES "exchange-tenant".use_case_steps(id);


--
-- Name: use_case_steps_workflows use_case_steps_workflows_step_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_workflows
    ADD CONSTRAINT use_case_steps_workflows_step_fk FOREIGN KEY (use_case_step_id) REFERENCES "exchange-tenant".use_case_steps(id);


--
-- Name: use_case_steps_workflows use_case_steps_workflows_workflow_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_case_steps_workflows
    ADD CONSTRAINT use_case_steps_workflows_workflow_fk FOREIGN KEY (workflow_id) REFERENCES "exchange-tenant".workflows(id);


--
-- Name: use_cases_sdg_targets usecases_sdgs_sdg_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_cases_sdg_targets
    ADD CONSTRAINT usecases_sdgs_sdg_fk FOREIGN KEY (sdg_target_id) REFERENCES "exchange-tenant".sdg_targets(id);


--
-- Name: use_cases_sdg_targets usecases_sdgs_usecase_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".use_cases_sdg_targets
    ADD CONSTRAINT usecases_sdgs_usecase_fk FOREIGN KEY (use_case_id) REFERENCES "exchange-tenant".use_cases(id);


--
-- Name: users user_organization_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".users
    ADD CONSTRAINT user_organization_fk FOREIGN KEY (organization_id) REFERENCES "exchange-tenant".organizations(id);


--
-- Name: workflows_building_blocks workflows_bbs_bb_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".workflows_building_blocks
    ADD CONSTRAINT workflows_bbs_bb_fk FOREIGN KEY (building_block_id) REFERENCES "exchange-tenant".building_blocks(id);


--
-- Name: workflows_building_blocks workflows_bbs_workflow_fk; Type: FK CONSTRAINT; Schema: exchange-tenant; Owner: -
--

ALTER TABLE ONLY "exchange-tenant".workflows_building_blocks
    ADD CONSTRAINT workflows_bbs_workflow_fk FOREIGN KEY (workflow_id) REFERENCES "exchange-tenant".workflows(id);
...
--
-- Name: candidate_status_relationships candidate_status_relationships_current_candidate_status_fk; Type: FK CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_status_relationships
    ADD CONSTRAINT candidate_status_relationships_current_candidate_status_fk FOREIGN KEY (current_candidate_status_id) REFERENCES health.candidate_statuses(id);


--
-- Name: candidate_status_relationships candidate_status_relationships_next_candidate_status_fk; Type: FK CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_status_relationships
    ADD CONSTRAINT candidate_status_relationships_next_candidate_status_fk FOREIGN KEY (next_candidate_status_id) REFERENCES health.candidate_statuses(id);
...
--
-- Name: candidate_products fk_rails_266c90eecf; Type: FK CONSTRAINT; Schema: health; Owner: -
--

ALTER TABLE ONLY health.candidate_products
    ADD CONSTRAINT fk_rails_266c90eecf FOREIGN KEY (candidate_status_id) REFERENCES health.candidate_statuses(id) ON DELETE SET NULL;
...
--
-- Name: candidate_status_relationships candidate_status_relationships_current_candidate_status_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.candidate_status_relationships
    ADD CONSTRAINT candidate_status_relationships_current_candidate_status_fk FOREIGN KEY (current_candidate_status_id) REFERENCES public.candidate_statuses(id);


--
-- Name: candidate_status_relationships candidate_status_relationships_next_candidate_status_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: candidate_products fk_rails_266c90eecf; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.candidate_products
    ADD CONSTRAINT fk_rails_266c90eecf FOREIGN KEY (candidate_status_id) REFERENCES public.candidate_statuses(id) ON DELETE SET NULL;
