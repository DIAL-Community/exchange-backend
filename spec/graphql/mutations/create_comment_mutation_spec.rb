...
RSpec.describe(Mutations::CreateComment, type: :graphql) do
  ...
  it 'creates comment' do
    ...
    result = execute_graphql_as_user(
      ...
      mutation,
      variables: {
        commentId: "d10a77ac-8ed5-4778-ad9d-6f0d51711b30",
  ...
  it 'creates reply' do
    ...
    create(
      :comment,
      id: 5,
      comment_id: "be01ea21-a13a-4d97-8218-250c2ab9ef40",
      comment_object_type: 'PRODUCT',
    ...
    result = execute_graphql_as_user(
      ...
      mutation,
      variables: {
        commentId: "3eb0da0f-2d13-4d96-b350-7ce49a80f088",
        commentObjectType: 'PRODUCT',
        commentObjectId: 1,
        text: 'Some reply',
        userId: 1,
  ...
  it 'updates comment' do
    ...
    create(
      :comment,
      comment_id: "d10a77ac-8ed5-4778-ad9d-6f0d51711b30",
      comment_object_type: 'PRODUCT',
      comment_object_id: 1,
      text: 'Some comment',
